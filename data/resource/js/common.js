...
(function($) {
    $.show_feiwa_login = function(options) {
        ...
        if (connect_qq == '1'){
            add_html += '<a href="'+MEMBER_SITE_URL+'/api.php?app=toqq" title="QQ账号登录" class="qq"><i></i></a>';
        }
        if (connect_sn == '1'){
            add_html += '<a href="'+MEMBER_SITE_URL+'/api.php?app=tosina" title="新浪微博账号登录" class="sina"><i></i></a>';
        }
        if (connect_wx == '1'){
