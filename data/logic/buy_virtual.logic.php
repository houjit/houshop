...
class buy_virtualLogic
{
    ...
    public function getBuyStepData($goods_id, $quantity, $member_id)
    {
        ...
        if ($goods_info['goods_storage'] < $goods_info['virtual_limit'])
        {
        ...
        $quantity = (($goods_info['virtual_limit'] < $quantity ? $goods_info['virtual_limit'] : $quantity));
    ...
    private function _createOrder($input, $goods_info, $member_info)
    {
        ...
        if (($goods_info['goods_storage'] - $input['quantity']) <= $goods_info['goods_storage_alarm'])
        {
            $param = array();
    ...
    private function _getGroupbuyInfo($goods_info = array())
    {
        ...
        if ((0 < $groupbuy_info['upper_limit']) && ($groupbuy_info['upper_limit'] < $goods_info['virtual_limit']))
        {
