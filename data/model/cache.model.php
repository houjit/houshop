...
class cacheModel extends Model {
    ...
    private function _admin_menu() {
        ...
        if (file_exists(BASE_PATH.DS.ADMIN_MODULES_MALL.'/include/menu.php')) {
            require(BASE_PATH.DS.ADMIN_MODULES_MALL.'/include/menu.php');
        }
        if (file_exists(BASE_PATH.DS.ADMIN_MODULES_READS.'/include/menu.php')) {
            require(BASE_PATH.DS.ADMIN_MODULES_READS.'/include/menu.php');
        }
        ...
        if (file_exists(BASE_PATH.DS.ADMIN_MODULES_MICEOMALL.'/include/menu.php')) {
            require(BASE_PATH.DS.ADMIN_MODULES_MICEOMALL.'/include/menu.php');
        }
		...
		if (file_exists(BASE_PATH.DS.ADMIN_MODULES_FEIWA.'/include/menu.php')) {
            require(BASE_PATH.DS.ADMIN_MODULES_FEIWA.'/include/menu.php');
        }
        return $_menu;
    }
    /**
