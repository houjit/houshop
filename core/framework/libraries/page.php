...
class Page {
        ...
        switch ($this->style) {
            ...
            case '4':
                ...
                if ($this->getNowPage() <= 1) {
                    ...
                    $html_page.= '<li><a class="demo" href="' . $this->setMallPseudoStaticPageUrl($this->getNowPage() - 1) . '">' . $this->left_inside_a_html . $this->pre_page2 . $this->right_inside_a_html . '</a></li>';
                }
                if ($this->getNowPage() == $this->getTotalPage() || $this->getTotalPage() == 0) {
                    $html_page.= '<li>' . $this->left_inside_a_html . $this->next_page2 . $this->right_inside_a_html . '</li>';
                } else {
                    $html_page.= '<li><a class="demo" href="' . $this->setMallPseudoStaticPageUrl($this->getNowPage() + 1) . '">' . $this->left_inside_a_html . $this->next_page2 . $this->right_inside_a_html . '</a></li>';
                }
                $html_page.= '</ul>';
                break;
            ...
            case '5':
                ...
                if ($this->getNowPage() <= 1) {
                    ...
                    $html_page.= '<li><a class="demo" href="' . $this->setMallPseudoStaticPageUrl('1') . '">' . $this->left_inside_a_html . $this->pre_home . $this->right_inside_a_html . '</a></li>';
                    $html_page.= '<li><a class="demo" href="' . $this->setMallPseudoStaticPageUrl($this->getNowPage() - 1) . '">' . $this->left_inside_a_html . $this->pre_page . $this->right_inside_a_html . '</a></li>';
                }
                $html_page.= $this->getNowBar();
                if ($this->getNowPage() == $this->getTotalPage() || $this->getTotalPage() == 0) {
                    $html_page.= '<li>' . $this->left_inside_a_html . $this->next_page . $this->right_inside_a_html . '</li>';
                    ...
                    $html_page.= '<li><a class="demo" href="' . $this->setMallPseudoStaticPageUrl($this->getNowPage() + 1) . '">' . $this->left_inside_a_html . $this->next_page . $this->right_inside_a_html . '</a></li>';
                    $html_page.= '<li><a class="demo" href="' . $this->setMallPseudoStaticPageUrl($this->getTotalPage()) . '">' . $this->left_inside_a_html . $this->pre_last . $this->right_inside_a_html . '</a></li>';
                }
                $html_page.= '</ul>';
                break;
    ...
    private function setPageHtml($page_name, $page) {
        if ($this->getNowPage() == $page) {
            ...
            $result = $this->left_html . "<a class='demo' href='" . $this->setMallPseudoStaticPageUrl($page) . "'>" . $this->left_inside_a_html . $page_name . $this->right_inside_a_html . "</a>" . $this->right_html;
        } else {
    ...
    private function setMallPseudoStaticPageUrl($page) {
        $param = $_GET;
        $app = ($param["app"] == "" ? "index" : $param["app"]);
        unset($param["app"]);
        $op = ($param["feiwa"] == "" ? "index" : $param["feiwa"]);
        unset($param["feiwa"]);
        $param[$this->page_name] = $page;
        return urlMall($app, $op, $param);
    }
}
defined("INSYSVIEW") || exit("Access Invalid! PAGE");
?>