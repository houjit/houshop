...
class member_fundControl extends mobileMemberControl {
     ...
     * 预存款日志列表
     */
    public function predepositlogFeiwa(){
     ...
     * 充值明细
     */
    public function pdrechargelistFeiwa(){
        $where = array();
     ...
     * 提现记录
     */
    public function pdcashlistFeiwa(){
        $where = array();
     ...
     * 预存款提现记录详细
     */
    public function pdcashinfoFeiwa(){
        $param = $_GET;
