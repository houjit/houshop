...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr>
      <td></td>
      <td><div class="pic-thumb"><a href="<?php echo urlMall('goods', 'index', array('goods_id' => $output['goodsid_array'][$val['goods_commonid']]['goods_id']));?>" target="_blank"><img src="<?php echo thumb($val, 60);?>"/></a></div></td>
      <td class="tl"><dl class="goods-name">
          <dt style="max-width: 450px !important;"> <a href="<?php echo urlMall('goods', 'index', array('goods_id' => $output['goodsid_array'][$val['goods_commonid']]['goods_id']));?>" target="_blank"><?php echo $val['goods_name']; ?></a></dt>
        </dl></td>
