...
$(document).ready(function() {
    ...
    function change_seccode() {
        $('#codeimage').attr('src', '<?php echo $chk_code; ?>index.php?app=seccode&feiwa=makecode&nchash=<?php echo $output['nchash'];?>&t=' + Math.random());
        $('#captcha').select();
    }
...
<div class="ncsc-login-container">
  ...
  <form id="chain_login" method="post" action="<?php echo urlChain('login','index');?>">
    ...
    <div class="code">
      <div class="arrow"></div>
      <div class="code-img"><a href="javascript:void(0)" nctype="btn_change_seccode"><img src="<?php echo $chk_code; ?>index.php?app=seccode&feiwa=makecode&nchash=<?php echo $output['nchash'];?>" name="codeimage" border="0" id="codeimage"></a></div>
...
<div class="copyright">Powered by <?php //echo $output['setting_config']['feiwa_version'];?>-<?php //echo mall_by_version;?> © <?php echo date('Y', time()); ?> </div>
