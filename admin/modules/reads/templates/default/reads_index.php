...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_reads_index_manage'];?></h3>
        <h5><?php echo $lang['sys_reads_index_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
...
<div id="page_module_<%=module_id%>" data-module-id="<%=module_id%>" data-module-name="<%=module_name%>" class="page-module <%=module_css%> <%=module_state_css%> module-css-<%=module_type%> module-style-<%=module_style%>">
    <div class="title">
    <span feiwa_type="module_title" column_id="<%=module_id%>" title="<?php echo $lang['sys_editable'];?>"><i></i><%=module_title%></span>
    </div>
    <div class="handle">
    ...
    <a href="index.php?app=reads_index&feiwa=module_edit&module_id=<%=module_id%>" class="edit" title="<?php echo $lang['sys_edit'];?>"></a>
