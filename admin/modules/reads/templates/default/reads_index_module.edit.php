...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=reads_index&feiwa=reads_index" title="返回模板"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_reads_index_manage'];?> - <?php echo $lang['reads_index_module_edit'];?></h3>
        <h5>资讯首页模板可视化编辑生成</h5>
      </div>
...
<div id="dialog_module_brand_edit" class="brand_list_dialog" style="display:none;">
  ...
  <div class="ncap-form-all" id="upload_adv_type">
    <dl class="row">
      <dt class="tit"><?php echo $lang['reads_index_module_brand_selected'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['reads_index_module_brand_list'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt">
