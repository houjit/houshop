...
class groupbuyControl extends SystemControl{
    ...
    public function __construct(){
        ...
        if (C('groupbuy_allow') != 1){
            $url = array(
                ...
                array(
                    'url'=>'index.php?app=groupbuy&feiwa=groupbuy_template_list&groupbuy_open=1',
     ...
     *
     */
    public function groupbuy_listFeiwa()
    {
    ...
    public function groupbuy_list_xmlFeiwa()
    {
        $condition = array();
        ...
        foreach ($groupbuy_list as $val) {
            $u = MALL_SITE_URL . "/index.php?app=show_groupbuy&feiwa=groupbuy_detail&group_id=" . $val['groupbuy_id'];
            $o = '<a class="btn red confirm-on-click" href="javascript:;" data-href="' . urlAdminMall('groupbuy', 'groupbuy_del', array(
            ...
            if ($val['reviewable']) {
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="' . urlAdminMall('groupbuy', 'groupbuy_review_pass', array(
                    'groupbuy_id' => $val['groupbuy_id'],
                )) . '">批准活动</a></li>';
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="' . urlAdminMall('groupbuy', 'groupbuy_review_fail', array(
                    'groupbuy_id' => $val['groupbuy_id'],
                )) . '">拒绝活动</a></li>';
            }

            if ($val['recommended'] == '1') {
                $o .= '<li><a href="javascript:;" data-href="' . urlAdminMall('groupbuy', 'groupbuy_rec', array(
                    'groupbuy_id' => $val['groupbuy_id'],
                    'rec' => 0,
                )) . '">取消推荐</a></li>';
            } else {
            ...
            if ($val['cancelable']) {
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="' . urlAdminMall('groupbuy', 'groupbuy_cancel', array(
                    'groupbuy_id' => $val['groupbuy_id'],
                )) . '">取消活动</a></li>';
            }
            ...
            $i['goods_name'] = '<a target="_blank" href="'
                . MALL_SITE_URL . "/index.php?app=goods&goods_id=" . $val['goods_id']
                . '">' . $val['goods_name'] . '</a>';
...
EOB;
     ...
     * 审核通过
     */
    public function groupbuy_review_passFeiwa(){
     ...
     * 审核失败
     */
    public function groupbuy_review_failFeiwa(){
        $groupbuy_id = intval($_REQUEST['groupbuy_id']);
     ...
     * 取消
     */
    public function groupbuy_cancelFeiwa() {
        $groupbuy_id = intval($_REQUEST['groupbuy_id']);
     ...
     * 删除
     */
    public function groupbuy_delFeiwa(){
        $groupbuy_id = intval($_REQUEST['groupbuy_id']);
     ...
     * 推荐
     */
    public function groupbuy_recFeiwa()
    {
     ...
     * 套餐管理
     */
    public function groupbuy_quotaFeiwa()
    {
     ...
     * 套餐管理
     */
    public function groupbuy_quota_xmlFeiwa()
    {
        $condition = array();
    ...
    public function class_saveFeiwa() {
        ...
        if(empty($class_id)) {
            ...
            if ($class_id = $model_groupbuy_class->save($param)) {
                ...
                showMessage(Language::get('groupbuy_class_add_success'),'index.php?app=groupbuy&feiwa=class_list');
            }
            else {
                showMessage(Language::get('groupbuy_class_add_fail'),'index.php?app=groupbuy&feiwa=class_list');
            }
        }
        else {
            //编辑
            if($model_groupbuy_class->updates($param,array('class_id'=>$class_id))) {
                ...
                showMessage(Language::get('groupbuy_class_edit_success'),'index.php?app=groupbuy&feiwa=class_list');
            }
            else {
                showMessage(Language::get('groupbuy_class_edit_fail'),'index.php?app=groupbuy&feiwa=class_list');
            }
        }
     ...
     * 抢购价格区间列表
     */
    public function price_listFeiwa()
    {
     ...
     * 抢购价格区间列表
     */
    public function price_list_xmlFeiwa()
    {
        ...
        foreach ($groupbuy_price_list as $val) {
            $o = '<a class="confirm-del-on-click btn red" href="index.php?app=groupbuy&feiwa=price_drop&range_id='
                . $val['range_id']
                . '"><i class="fa fa-trash-o"></i>删除</a>';
            $o .= '<a class="btn blue" href="index.php?app=groupbuy&feiwa=price_edit&range_id='
                . $val['range_id']
     ...
     * 添加抢购价格区间页面
     */
    public function price_addFeiwa() {
     ...
     * 编辑抢购价格区间页面
     */
    public function price_editFeiwa() {
     ...
     * 保存添加的抢购价格区间
     */
    public function price_saveFeiwa() {
        ...
        if(empty($range_id)) {
            ...
            if($model->save($param)) {
                ...
                showMessage(Language::get('groupbuy_price_range_add_success'),'index.php?app=groupbuy&feiwa=price_list');
            }
            else {
                showMessage(Language::get('groupbuy_price_range_add_fail'),'index.php?app=groupbuy&feiwa=price_list');
            }
        }
        else {
            //编辑
            if($model->updates($param,array('range_id'=>$range_id))) {
                ...
                showMessage(Language::get('groupbuy_price_range_edit_success'),'index.php?app=groupbuy&feiwa=price_list');
            }
            else {
                showMessage(Language::get('groupbuy_price_range_edit_fail'),'index.php?app=groupbuy&feiwa=price_list');
            }
        }
     ...
     * 删除抢购价格区间
     */
    public function price_dropFeiwa() {
     ...
     * 设置
     **/
    public function groupbuy_settingFeiwa() {
    ...
    public function groupbuy_setting_saveFeiwa() {
     ...
     * 幻灯片清空
     */
    public function slider_clearFeiwa()
    {
        $model_setting = Model('setting');
        $update = array();
        $update['live_pic1'] = '';
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'groupbuy_list'=>array('menu_type'=>'link','menu_name'=>'抢购活动','menu_url'=>'index.php?app=groupbuy&feiwa=groupbuy_list'),
            'groupbuy_quota'=>array('menu_type'=>'link','menu_name'=>'套餐管理','menu_url'=>'index.php?app=groupbuy&feiwa=groupbuy_quota'),
            'class_list'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_class_list'),'menu_url'=>'index.php?app=groupbuy&feiwa=class_list'),
            'class_add'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_class_add'),'menu_url'=>'index.php?app=groupbuy&feiwa=class_add'),
            'price_list'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_price_list'),'menu_url'=>'index.php?app=groupbuy&feiwa=price_list'),
            'price_add'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_price_add'),'menu_url'=>'index.php?app=groupbuy&feiwa=price_add'),
            'price_edit'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_price_edit'),'menu_url'=>'index.php?app=groupbuy&feiwa=price_edit'),
            'groupbuy_setting'=>array('menu_type'=>'link','menu_name'=>'设置','menu_url'=>urlAdminMall('groupbuy', 'groupbuy_setting')),
            'slider'=>array('menu_type'=>'link','menu_name'=>'幻灯片管理','menu_url'=>urlAdminMall('groupbuy', 'slider')),
        );
        switch ($menu_key) {
            case 'class_add':
