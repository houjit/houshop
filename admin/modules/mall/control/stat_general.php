...
class stat_generalControl extends SystemControl{
    private $links = array(
        array('url'=>'app=stat_general&feiwa=general','lang'=>'stat_generalindex'),
        array('url'=>'app=stat_general&feiwa=setting','lang'=>'stat_goodspricerange'),
        array('url'=>'app=stat_general&feiwa=orderprange','lang'=>'stat_orderpricerange')
    );
    ...
    public function settingFeiwa(){
        ...
        if (chksubmit()){
            ...
            if ($result === true){
                $this->log(L('feiwa_edit,stat_setting'),1);
                showMessage(L('feiwa_common_save_succ'));
            }else {
                $this->log(L('feiwa_edit,stat_setting'),0);
