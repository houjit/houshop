...
<div class="page">
  ...
  <form method="post" name="form_consultingsetting">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" onclick="document.form_consultingsetting.submit()"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
