...
<div class="fixed-bar">
  <div class="item-title"><a class="back" href="index.php?app=ownmall&feiwa=list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
    <div class="subject">
      <h3>自营店铺 - <?php echo $lang['sys_edit'];?>“<?php echo $output['store_info']['store_name'];?>”经营类目</h3>
      <h5>商城自营店铺相关设置与管理</h5>
    </div>
  </div>
</div>
...
<table class="flex-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="sort"><span feiwa_type="commis_rate" column_id="<?php echo $value['bid'];?>" title="<?php echo $lang['sys_editable'];?>" class="editable " style="vertical-align: middle; margin-right: 4px;"><?php echo $value['commis_rate'];?></span>% </td>
