...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=brand&feiwa=brand" title="返回品牌列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['brand_index_brand'];?> - <?php echo $lang['sys_edit'];?>品牌“<?php echo $output['brand_array']['brand_name']?>”</h3>
  ...
  <form id="brand_form" method="post" name="form1" enctype="multipart/form-data">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="brand_recommend1" class="cb-enable <?php if($output['brand_array']['brand_recommend'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_yes'];?>"><?php echo $lang['sys_yes'];?></label>
            <label for="brand_recommend0" class="cb-disable <?php if($output['brand_array']['brand_recommend'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_no'];?>"><?php echo $lang['sys_no'];?></label>
    ...
    (
      {
        ...
        success: function (data, status)
        {
          if (data.status == 1){
          	if(id=='_pic'){
            ajax_form('cutpic','<?php echo $lang['sys_cut'];?>','<?php echo ADMIN_SITE_URL?>/index.php?app=common&feiwa=pic_cut&type=brand&x=150&y=50&resize=1&ratio=3&url='+data.url,690);
            }else if(id=='_bgpic'){
