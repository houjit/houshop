  ...
  <form id="post_form" method="post" action="index.php?app=vr_refund&feiwa=edit&refund_id=<?php echo $output['refund']['refund_id']; ?>">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="state1" class="cb-enable" title="<?php echo $lang['sys_yes'];?>"><?php echo $lang['sys_yes'];?></label>
            <label for="state0" class="cb-disable" title="<?php echo $lang['sys_no'];?>"><?php echo $lang['sys_no'];?></label>
