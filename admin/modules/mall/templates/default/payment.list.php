...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_pay_method'];?></h3>
  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle-s"><a class="btn purple" href="index.php?app=payment&feiwa=edit&payment_id=<?php echo $v['payment_id']; ?>"><i class="fa fa-cog"></i><?php echo $lang['sys_set']?></a></td>
