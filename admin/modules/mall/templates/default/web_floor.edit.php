  ...
  <form id="web_form" method="post" name="form1">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="show1" class="cb-enable <?php if($output['web']['web_show'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_yes'];?>"><?php echo $lang['sys_yes'];?></label>
            <label for="show0" class="cb-disable <?php if($output['web']['web_show'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_no'];?>"><?php echo $lang['sys_no'];?></label>
