...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=store&feiwa=store" title="返回<?php echo $lang['manage'];?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_store_manage'];?> - 编辑会员“<?php echo $output['joinin_detail']['member_name'];?>”的店铺信息</h3>
  ...
  <h3>编辑店铺信息</h3>
    ...
    <form id="joinin_form" enctype="multipart/form-data" method="post" action="index.php?app=store&feiwa=edit_save_joinin" style="display:none;">
      ...
      <div><a id="btn_fail" class="ncap-btn-big ncap-btn-green" href="JavaScript:void(0);"><?php echo $lang['sys_submit'];?></a></div>
    </form>
  </div>
</div>
