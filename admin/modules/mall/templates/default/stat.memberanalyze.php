...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      ...
      <input type="hidden" name="feiwa" value="analyze" />
...
$(function() {
    ...
    $("#list_ordernum").flexigrid({
        url: 'index.php?app=stat_member&feiwa=get_analyzeinfo_xml&type=ordernum&t=<?php echo $output['searchtime'];?>',
        colModel : [
    ...
    $("#list_orderamount").flexigrid({
        url: 'index.php?app=stat_member&feiwa=get_analyzeinfo_xml&type=orderamount&t=<?php echo $output['searchtime'];?>',
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
            {display: '序号', name : 'number', width : 100, sortable : false, align: 'center'},
            {display: '会员名称', name : 'statm_membername',  width : 150, sortable : false, align: 'center'},
    ...
    $("#list_goodsnum").flexigrid({
        url: 'index.php?app=stat_member&feiwa=get_analyzeinfo_xml&type=goodsnum&t=<?php echo $output['searchtime'];?>',
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
            {display: '序号', name : 'number', width : 100, sortable : false, align: 'center'},
            {display: '会员名称', name : 'statm_membername',  width : 150, sortable : false, align: 'center'},
...
function fg_operation_excel(stat_type,obj){
    var stat_url = 'index.php?app=stat_member&feiwa=analyzeinfo&exporttype=excel&t=<?php echo $output['searchtime'];?>&type='+stat_type;
