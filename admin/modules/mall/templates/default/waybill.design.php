...
<div class="page"> 
  <!-- 页面导航 -->
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=waybill&feiwa=waybill_list" title="返回运单模板列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <div class="ncap-form-default">
    <dl class="row">
      ...
      <dd class="opt">
        <form id="design_form" action="<?php echo urlAdminMall('waybill', 'waybill_design_save');?>" method="post">
    ...
    <div class="bot"><a id="submit" href="javascript:;" class="ncap-btn-big ncap-btn-green"><?php echo $lang['sys_submit'];?></a></div>
  </div>
</div>
