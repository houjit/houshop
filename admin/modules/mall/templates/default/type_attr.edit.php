<?php defined('INSYSVIEW') or exit('Access Invalid!');?>
  ...
  <form id="attr_form" method="post" class="ncap-form-dialog" action="<?php echo urlAdminMall('type', 'attr_edit');?>">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="attr_sort"><em>*</em><?php echo $lang['sys_sort'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="attr_show1" class="cb-enable <?php if($output['attr_info']['attr_show'] == '1'){?>selected<?php }?>"><?php echo $lang['sys_yes'];?></label>
            <label for="attr_show0" class="cb-disable <?php if($output['attr_info']['attr_show'] == '0'){?>selected<?php }?>"><?php echo $lang['sys_no'];?></label>
    ...
    <div class="ncap-form-all">
        ...
        <dd class="opt">
          <ul class="ncap-ajax-add" id="attr_model">
            ...
            <li>
              ...
              <label class="ml20"><?php echo $lang['sys_sort'];?>：
      ...
      <div class="bot"><a id="attrSubmitBtn" class="ncap-btn-big ncap-btn-green" href="JavaScript:void(0);"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
...
//自动加载滚动条
    ...
    var attr_i=0;
	var attr_model = '<li>'+
		'<label style="width: 64px;"></label><label class="ml20"><?php echo $lang['sys_sort'];?>：<input type="text" name="attr_value[key][sort]" value="0" class="w30"/></label>'+
		'<label class="ml20">可选值：<input type="text" name="attr_value[key][name]" value="" class="w150"/></label>'+
		'<label class="ml10"><a onclick="remove_tr($(this));" href="JavaScript:void(0);" class="ncap-btn ncap-btn-red"><?php echo $lang['sys_del'];?></a></label>'+
	'</li>';
