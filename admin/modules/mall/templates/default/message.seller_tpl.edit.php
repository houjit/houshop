...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=message&feiwa=seller_tpl" title="返回商家消息模板列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_message_set'];?> - <?php echo $lang['sys_edit'];?>商家消息模板“<?php echo $output['smtpl_info']['smt_name'];?>”</h3>
        <h5><?php echo $lang['sys_message_set_subhead'];?></h5>
      </div>
    </div>
  </div>
  <!-- 操作说明 -->
    ...
    <form class="tab-content" method="post" name="message_form" >
      ...
      <div class="ncap-form-default">
        ...
        <dl class="row">
          ...
          <dd class="opt">
            <div class="onoff">
              <label for="message_forced1" class="cb-enable <?php if($output['smtpl_info']['smt_message_forced'] == 1){?>selected<?php }?>"><?php echo $lang['sys_yes'];?></label>
              <label for="message_forced0" class="cb-disable <?php if($output['smtpl_info']['smt_message_forced'] == 0){?>selected<?php }?>"><?php echo $lang['sys_no'];?></label>
        ...
        <div class="bot"> <a href="JavaScript:void(0);" onclick="document.message_form.submit();" class="ncap-btn-big ncap-btn-green"><?php echo $lang['sys_submit'];?></a></div>
      </div>
    </form>
    <!-- 站内信 E --> 
    <!-- 短消息 S -->
    <form class="tab-content" method="post" name="short_name" style="display:none;">
      ...
      <div class="ncap-form-default">
        ...
        <dl class="row">
          ...
          <dd class="opt">
            <div class="onoff">
              <label for="short_forced1" class="cb-enable <?php if($output['smtpl_info']['smt_short_forced'] == 1){?>selected<?php }?>"><?php echo $lang['sys_yes'];?></label>
              <label for="short_forced0" class="cb-disable <?php if($output['smtpl_info']['smt_short_forced'] == 0){?>selected<?php }?>"><?php echo $lang['sys_no'];?></label>
        ...
        <div class="bot"> <a href="JavaScript:void(0);" onclick="document.short_name.submit();" class="ncap-btn-big ncap-btn-green"><?php echo $lang['sys_submit'];?></a></div>
      </div>
    </form>
    <!-- 短消息 E --> 
    <!-- 邮件 S -->
    <form class="tab-content" method="post" name="mail_form" style="display:none;">
      ...
      <div class="ncap-form-default">
        ...
        <dl class="row">
          ...
          <dd class="opt">
            <div class="onoff">
              <label for="mail_forced1" class="cb-enable <?php if($output['smtpl_info']['smt_mail_forced'] == 1){?>selected<?php }?>"><?php echo $lang['sys_yes'];?></label>
              <label for="mail_forced0" class="cb-disable <?php if($output['smtpl_info']['smt_mail_forced'] == 0){?>selected<?php }?>"><?php echo $lang['sys_no'];?></label>
        ...
        <div class="bot"> <a href="JavaScript:void(0);" onclick="document.mail_form.submit();" class="ncap-btn-big ncap-btn-green"><?php echo $lang['sys_submit'];?></a> </div>
      </div>
    </form>
    <!-- 邮件 E --> 
  </div>
