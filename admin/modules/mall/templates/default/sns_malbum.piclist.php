...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=sns_malbum&feiwa=class_list" title="返回<?php echo $lang['snsalbum_class_list'];?>"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_member_album_manage'];?> - <?php echo $lang['snsalbum_pic_list'];?></h3>
        <h5><?php echo $lang['sys_member_album_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form method='post' id="form_pic">
    ...
    <ul class="ncap-thumb-list">
      ...
      <li class="picture">
        ...
        <a href="javascript:void(0);" onclick="if(confirm('<?php echo $lang['sys_ensure_del'];?>')){location.href='index.php?app=sns_malbum&feiwa=del_pic&id=<?php echo $val['ap_id'];?>';}else{return false;}" class="del" title="<?php echo $lang['sys_del'];?>">X</a> </li>
      <?php } ?>
    </ul>
    <?php }else { ?>
