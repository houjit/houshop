...
$(document).ready(function(){
  ...
  <div class="ncap-order-details">
    ...
    <div class="tabs-panels">
      <div class="misc-info">
        <dl>
          <dt><?php echo $lang['order_mall_name'];?><?php echo $lang['sys_colon'];?></dt>
          ...
          <dt><?php echo $lang['order_state'];?><?php echo $lang['sys_colon'];?></dt>
          <dd><?php echo $output['order_info']['order_state_text'];?></dd>
          <dt>订单号<?php echo $lang['sys_colon'];?></dt>
          ...
          <dt><?php echo $lang['order_datetime'];?><?php echo $lang['sys_colon'];?></dt>
          <dd><?php echo date('Y-m-d H:i:s',$output['order_info']['add_time']);?>
          <dt><?php echo $lang['order_price'];?><?php echo $lang['sys_colon'];?></dt>
          ...
          <dt><?php echo $lang['order_voucher_price'];?><?php echo $lang['sys_colon'];?></dt>
          <dd><?php echo $lang['currency'].$output['order_info']['voucher_price'].'.00';?>
          <dt><?php echo $lang['order_voucher_sn'];?><?php echo $lang['sys_colon'];?></dt>
  ...
  <div class="ncap-form-default">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_state'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt"><?php echo $output['complain_info']['complain_state_text'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_subject_content'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt"><?php echo $output['complain_info']['complain_subject_content'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_accuser'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt"><?php echo $output['complain_info']['accuser_name'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_evidence'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt">
        <?php
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_datetime'];?><?php echo $lang['sys_colon'];?></dt>
  ...
  <div class="ncap-form-default">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_accused'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt"><?php echo $output['complain_info']['accused_name'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_appeal_evidence'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt">
      <?php
    ...
    <dl class="row">
      <dt class="tit"> <?php echo $lang['complain_appeal_datetime'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt"><?php echo date('Y-m-d H:i:s',$output['complain_info']['appeal_datetime']);?></dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_appeal_content'];?><?php echo $lang['sys_colon'];?></dt>
  ...
  <div class="ncap-form-default">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['talk_list'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt">
    ...
    <dl cass="row">
      <dt class="tit"><?php echo $lang['talk_send'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt">
...
function forbit_talk(talk_id) {
  ...
  <div class="ncap-form-default">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['final_handle_message'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt"><?php echo $output['complain_info']['final_handle_message'];?></dd>
    </dl>
    <dl>
      <dt class="tit"><?php echo $lang['final_handle_datetime'];?><?php echo $lang['sys_colon'];?></dt>
      <dd class="opt"><?php echo date('Y-m-d H:i:s',$output['complain_info']['final_handle_datetime']);?></dd>
    </dl>
    <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" onclick="history.go(-1)"><?php echo $lang['sys_back'];?></a></div>
  </div>
  <?php } ?>
  <?php if(intval($output['complain_info']['complain_state']) !== 99) { ?>
  <div class="ncap-form-default">
    ...
    <dl class="row" id="close_complain">
      ...
      <form method='post' id="verify_form" action="index.php?app=complain&feiwa=complain_verify">
          ...
          <?php } ?>
          <a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" onclick="history.go(-1)"><span><?php echo $lang['sys_back'];?></span></a>
        </form></div></dd>
    </dl>
    <form method='post' id="close_form" action="index.php?app=complain&feiwa=complain_close">
      ...
      <dd class="opt">
        ...
        <div class="bot complain_dialog"><a id="btn_handle_submit" class="ncap-btn-big ncap-btn-green" href="javascript:void(0)"><?php echo $lang['sys_submit'];?></a> <a id="btn_close_cancel" class="ncap-btn-big ncap-btn-green" href="javascript:void(0)"><?php echo $lang['sys_cancel'];?></a></div>
    </form>
  </div>
  <?php } ?>
</div>
