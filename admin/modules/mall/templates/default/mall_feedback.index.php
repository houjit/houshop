...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=mall_feedback&feiwa=get_xml',
        colModel : [
            ...
            {display: '反馈内容', name : 'content', width : 310, sortable : true, align: 'left'},
...
function fg_del(ids) {
    ...
    if(confirm('删除后将不能恢复，确认删除这项吗？')){
        $.getJSON('index.php?app=mall_feedback&feiwa=del', {id:id}, function(data){
            if (data.state) {
