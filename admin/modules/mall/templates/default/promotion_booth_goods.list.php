...
<?php if ($output['store_info']) { ?>
      ...
      <div class="subject">
        <h3><?php echo $lang['sys_promotion_booth']; ?> - 查看/管理店铺“<?php echo $output['store_info']['store_name']; ?>”参与活动的商品</h3>
        <h5><?php echo $lang['sys_promotion_booth_subhead']; ?></h5>
      </div>
<?php } else { ?>
      <div class="subject">
        <h3><?php echo $lang['sys_promotion_booth'];?></h3>
        <h5><?php echo $lang['sys_promotion_booth_subhead'];?></h5>
      </div>
      <ul class="tab-base nc-row">
        ...
        <li><a href="<?php echo urlAdminMall('promotion_booth', 'booth_setting');?>"><?php echo $lang['sys_config'];?></a></li>
      </ul>
<?php } ?>
    </div>
  </div>
