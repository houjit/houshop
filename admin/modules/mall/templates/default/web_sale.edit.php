        ...
        <dd class="opt sale-layout">
          ...
          <dl sale_id="<?php echo $key;?>">
            <dt class="title">
              ...
              <a href="JavaScript:del_sale_list(<?php echo $key;?>);" class="ncap-btn-mini del"><i class="fa fa-trash"></i>删除</a><a href="JavaScript:show_sale_dialog(<?php echo $key;?>);" class="ncap-btn-mini edit"><i class="fa fa-pencil-square-o"></i><?php echo $lang['sys_edit'];?></a> </dt>
            <dd>
              <ul>
    ...
    <dl class="row">
      ...
      <dd class="opt">
        <div class="search-bar" id="gcategory">
          ...
          <a href="JavaScript:void(0);" onclick="get_goods_list();" class="ncap-btn"><?php echo $lang['sys_query'];?></a></div>
      </dd>
    </dl>
