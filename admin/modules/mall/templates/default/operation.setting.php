...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_operation_set']?></h3>
        <h5><?php echo $lang['sys_operation_set_subhead']?></h5>
      </div>
    </div>
  </div>
  <form method="post" name="settingForm" id="settingForm">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="points_isuse_1" class="cb-enable <?php if($output['list_setting']['points_isuse'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_open'];?>"><span><?php echo $lang['sys_open'];?></span></label>
            <label for="points_isuse_0" class="cb-disable <?php if($output['list_setting']['points_isuse'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_close'];?>"><span><?php echo $lang['sys_close'];?></span></label>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="pointmall_isuse_1" class="cb-enable <?php if($output['list_setting']['pointmall_isuse'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_open'];?>"><span><?php echo $lang['sys_open'];?></span></label>
            <label for="pointmall_isuse_0" class="cb-disable <?php if($output['list_setting']['pointmall_isuse'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_close'];?>"><span><?php echo $lang['sys_close'];?></span></label>
