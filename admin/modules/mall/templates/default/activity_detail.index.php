...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" name="formSearch" id="formSearch">
      ...
      <div class="bottom"> <a href="javascript:void(0);" id="ncsubmit" class="ncap-btn ncap-btn-green">提交查询</a> <a href="javascript:void(0);" id="ncreset" class="ncap-btn ncap-btn-orange" title="撤销查询结果，还原列表项所有内容"><i class="fa fa-retweet"></i><?php echo $lang['sys_cancel_search'];?></a> </div>
    </form>
  </div>
</div>
<script>
$(function(){
    var flexUrl = 'index.php?app=activity&feiwa=detail_xml&id=<?php echo $output['activity_detail']['activity_id']; ?>';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    var href = 'index.php?app=activity&feiwa=deal&state=1&activity_detail_id=__IDS__'.replace('__IDS__', ids.join(','));
                    performReq(href);
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    var href = 'index.php?app=activity&feiwa=deal&state=2&activity_detail_id=__IDS__'.replace('__IDS__', ids.join(','));
                    performReq(href);
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    var href = 'index.php?app=activity&feiwa=del_detail&activity_detail_id=__IDS__'.replace('__IDS__', ids.join(','));
                    performReq(href);
                }
            }
        ],
...
$("span[data-live-inline-edit='activity_detail_sort']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.get('index.php?app=activity&feiwa=ajax&branch=activity_detail_sort', {
