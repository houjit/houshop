...
<div class="page">
  ...
  <form method="post" name="form1" id="form1" action="index.php?app=<?php echo $_GET['app'];?>&feiwa=change_state&state_type=receive_pay&order_id=<?php echo intval($_GET['order_id']);?>">
