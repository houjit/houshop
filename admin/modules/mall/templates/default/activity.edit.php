...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=activity&feiwa=activity" title="返回<?php echo $lang['sys_manage'];?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['activity_index_manage'];?> - <?php echo $lang['sys_edit'];?>活动“<?php echo $output['activity']['activity_title'];?>”</h3>
  ...
  <form id="add_form" method="post" enctype="multipart/form-data">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="activity_sort"><em>*</em><?php echo $lang['sys_sort'];?></label>
        </dt>
        <dd class="opt">
