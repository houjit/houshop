...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_domain_manage'];?></h3>
        <h5><?php echo $lang['sys_domain_manage_subhead'];?></h5>
      </div>
      <ul class="tab-base nc-row">
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['sys_config'];?></a></li>
        <li><a href="index.php?app=domain&feiwa=store_domain_list"><?php echo $lang['sys_domain_mall'];?></a></li>
      </ul>
    </div>
  </div>
  <form method="post" id="settingForm" name="settingForm">
	...
	<dl class="row">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
          <label for="enabled_subdomain1" class="cb-enable <?php if($output['list_setting']['enabled_subdomain'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_yes'];?>"><?php echo $lang['sys_yes'];?></label>
          <label for="enabled_subdomain0" class="cb-disable <?php if($output['list_setting']['enabled_subdomain'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_no'];?>"><?php echo $lang['sys_no'];?></label>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="subdomain_edit1" class="cb-enable <?php if($output['list_setting']['subdomain_edit'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_yes'];?>"><?php echo $lang['sys_yes'];?></label>
            <label for="subdomain_edit0" class="cb-disable <?php if($output['list_setting']['subdomain_edit'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_no'];?>"><?php echo $lang['sys_no'];?></label>
