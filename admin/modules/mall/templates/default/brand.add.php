...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=brand&feiwa=brand" title="返回品牌列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['brand_index_brand'];?> - <?php echo $lang['sys_new'];?></a></h3>
  ...
  <form id="brand_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="brand_recommend1" class="cb-enable"><?php echo $lang['sys_yes'];?></label>
            <label for="brand_recommend0" class="cb-disable selected"><?php echo $lang['sys_no'];?></label>
