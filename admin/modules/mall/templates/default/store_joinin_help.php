  ...
  <table class="flex-table">
    <thead>
      <tr>
        ...
        <th width="80" align="center"><?php echo $lang['sys_sort'];?></th>
    ...
    <tbody>
      ...
      <tr data-id="<?php echo $val['help_id'];?>">
        ...
        <td class="handle-s"><a class="btn blue" href="index.php?app=store_joinin&feiwa=edit_help&help_id=<?php echo $val['help_id'];?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['sys_edit'];?></a></td>
