...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_web_index'];?></h3>
  ...
  <table class="flex-table">
    <thead>
      <tr>
        ...
        <th width="60" align="center"><?php echo $lang['sys_display'];?></th>
        <th></th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo $v['web_show']==1 ? '<span class="yes"><i class="fa fa-check-circle"></i>'.$lang['sys_yes'].'</span>' : '<span class="no"><i class="fa fa-ban"></i>'.$lang['sys_no'].'</span>';?></td>
        <td></td>
      </tr>
      <?php } ?>
      <?php }else { ?>
