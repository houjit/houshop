    ...
    <div class="ncap-order-details">
      ...
      <div class="tabs-panels">
        <div class="misc-info">
          <h4>下单/支付</h4>
          <dl>
            <dt><?php echo $lang['order_number'];?><?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo $output['order_info']['order_sn'];?></dd>
            <dt>订单来源<?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo str_replace(array(1,2), array('PC端','移动端'),$output['order_info']['order_from']);?></dd>
            <dt><?php echo $lang['order_time'];?><?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo date('Y-m-d H:i:s',$output['order_info']['add_time']);?></dd>
          </dl>
          <?php if(intval($output['order_info']['payment_time'])){?>
          <dl>
            <dt>支付单号<?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo $output['order_info']['order_sn'];?></dd>
            <dt><?php echo $lang['payment'];?><?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo orderPaymentName($output['order_info']['payment_code']);?></dd>
            <dt><?php echo $lang['payment_time'];?><?php echo $lang['sys_colon'];?></dt>
          ...
          <?php if ($output['order_info']['order_state'] == ORDER_STATE_CANCEL) { ?>
          <dl>
            <dt>订单取消日志<?php echo $lang['sys_colon'];?></dt>
        ...
        <div class="addr-note">
          <h4>购买/收货方信息</h4>
          <dl>
            <dt><?php echo $lang['buyer_name'];?><?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo $output['order_info']['buyer_name'];?></dd>
            <dt>接收手机<?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo $output['order_info']['buyer_phone'];?></dd>
          </dl>
          <dl>
            <dt>买家留言<?php echo $lang['sys_colon'];?></dt>
        ...
        <div class="contact-info">
          ...
          <dl>
            <dt>交通信息<?php echo $lang['sys_colon'];?></dt>
        ...
        <div class="goods-info">
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td class="w30"><div class="goods-thumb"><a href="<?php echo MALL_SITE_URL;?>/index.php?app=goods&goods_id=<?php echo $output['order_info']['goods_id'];?>" target="_blank"><img alt="<?php echo $lang['product_pic'];?>" src="<?php echo thumb($output['order_info'], 60);?>" /> </a></span></div></td>
                <td style="text-align: left;"><a href="<?php echo MALL_SITE_URL;?>/index.php?app=goods&goods_id=<?php echo $output['order_info']['goods_id'];?>" target="_blank"><?php echo $output['order_info']['goods_name'];?></a><span class="rec"><a target="_blank" href="<?php echo urlMall('vr_snapshot', 'index', array('order_id' => $output['order_info']['order_id']));?>">[交易快照]</a></span>
        ...
        <div class="total-amount">
          <h3><?php echo $lang['order_total_price'];?><?php echo $lang['sys_colon'];?><strong class="red_common"><?php echo $lang['currency'].ncPriceFormat($output['order_info']['order_amount']);?></strong></h3>
        </div>
      </div>
      <?php if(is_array($output['refund_list']) and !empty($output['refund_list'])) { ?>
