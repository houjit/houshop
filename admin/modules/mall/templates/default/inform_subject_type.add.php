...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=inform&feiwa=inform_subject_type_list" title="返回举报类型列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['inform_manage_title'];?> - <?php echo $lang['sys_new'];?></h3>
  ...
  <form id="add_form" method="post" action="index.php?app=inform&feiwa=inform_subject_type_save" name="form1">
    <div class="ncap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="btn_add"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
