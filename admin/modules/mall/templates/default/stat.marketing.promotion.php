...
<div class="page">
  ...
  <div id="stat_tabs">
    <ul class="tab-base nc-row">
      <li><a href="#ordernum_div" feiwa_type="showlinelabels" data-param='{"type":"ordernum"}'>下单量</a></li>
      <li><a href="#goodsnum_div" feiwa_type="showlinelabels" data-param='{"type":"goodsnum"}'>下单商品数</a></li>
      <li><a href="#orderamount_div" feiwa_type="showlinelabels" data-param='{"type":"orderamount"}'>下单金额</a></li>
    </ul>
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      <input type="hidden" name="app" value="stat_marketing" />
      <input type="hidden" name="feiwa" value="promotion" />
...
$(function() {
	...
	$("[feiwa_type='showlinelabels']").click(function(){
...
function getLineLabels(stattype){
	...
	if(!$("#"+stattype+'_div').html()){
		$("#"+stattype+'_div').load('index.php?app=stat_marketing&feiwa=promotiontrend&search_type='+search_type+'&stattype='+stattype+'&t=<?php echo $output['searchtime'];?>');
	}
}
</script>