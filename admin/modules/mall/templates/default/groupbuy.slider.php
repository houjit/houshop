...
<div class="page">
  ...
  <form id="live_form" method="post" enctype="multipart/form-data">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['sys_submit'];?></a> <a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-red ml10" id="clearBtn">清空数据</a></div>
    </div>
  </form>
</div>
