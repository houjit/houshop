...
<table class="flex-table">
  <thead>
    <tr>
      ...
      <th width="60" class="handle-s" align="center"><?php echo $lang['sys_handle'];?></th>
  ...
  <tbody>
    ...
    <tr class="hover edit">
      ...
      <td class="sort"><span feiwa_type="commis_rate" column_id="<?php echo $value['bid'];?>" title="<?php echo $lang['sys_editable'];?>" class="editable" style="vertical-align: middle; margin-right: 4px; width:40px;"><?php echo $value['commis_rate'];?></span>% </td>
...
$(document).ready(function(){
    ...
    // 修改分佣比   例    
	$('span[feiwa_type="commis_rate"]').inline_edit({app: 'store',op: 'store_bind_class_update'});
