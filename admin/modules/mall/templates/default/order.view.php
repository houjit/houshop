    ...
    <div class="ncap-order-details">
      ...
      <div class="tabs-panels">
        ...
        <div class="addr-note">
          ...
          <dl>
            <dt>发票信息<?php echo $lang['sys_colon'];?></dt>
            <dd>
              ...
              <ul>
                ...
                <li><strong><?php echo $key.$lang['sys_colon'];?></strong><?php echo $value;?></li>
                <?php } ?>
              </ul>
              <?php } ?>
            </dd>
        ...
        <div class="contact-info">
          ...
          <dl>
            ...
            <dd><?php echo $output['order_info']['store_name'];?></dd><dt>店主名称<?php echo $lang['sys_colon'];?></dt>
          ...
          <dl>
            <dt>发货地址<?php echo $lang['sys_colon'];?></dt>
          ...
          <dl>
            <dt>发货时间<?php echo $lang['sys_colon'];?></dt>
            ...
            <dt>快递公司<?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo $output['order_info']['express_info']['e_name'];?></dd>
            <dt>物流单号<?php echo $lang['sys_colon'];?></dt>
            <dd>
        ...
        <div class="total-amount">
          ...
          <h4>(<?php echo $lang['order_total_transport'];?><?php echo $lang['sys_colon'];?><?php echo $lang['currency'].ncPriceFormat($output['order_info']['shipping_fee']);?>)</h4>
          <?php if($output['order_info']['refund_amount'] > 0) { ?>
          (<?php echo $lang['order_refund'];?><?php echo $lang['sys_colon'];?><?php echo $lang['currency'].ncPriceFormat($output['order_info']['refund_amount']);?>)
          <?php } ?>
        </div>
      </div>
      <?php if(is_array($output['refund_list']) and !empty($output['refund_list'])) { ?>
      <div class="tabs-panels tabs-hide">
        <div>
          ...
          <dl>
            ...
            <dt>发生时间<?php echo $lang['sys_colon'];?></dt>
      ...
      <div class="tabs-panels tabs-hide">
        <div>
          ...
          <dl>
            <dt>退货单号<?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo $val['refund_sn'];?></dd>
            <dt>退款金额<?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo $lang['currency'];?><?php echo ncPriceFormat($val['refund_amount']); ?></dd>
            <dt>发生时间<?php echo $lang['sys_colon'];?></dt>
