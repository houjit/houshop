...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=goods_class&feiwa=goods_class" title="返回商品分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['goods_class_index_class'];?> - <?php echo $lang['sys_new'];?></h3>
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <p class="notic"><?php echo $lang['goods_class_add_type_desc_one'];?><a onclick="window.parent.openItem('mall|type')" href="JavaScript:void(0);" class="ncap-btn mr5 ml5"><?php echo $lang['sys_type_manage'];?></a><?php echo $lang['goods_class_add_type_desc_two'];?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
          <label><?php echo $lang['sys_sort'];?></label>
        </dt>
        <dd class="opt">
