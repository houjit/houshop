...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=spec&feiwa=spec" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_spec_manage'];?> - <?php echo $lang['sys_edit'];?></h3>
        <h5><?php echo $lang['sys_spec_manage_subhead'];?></h5>
        <h5></h5>
      </div>
    </div>
  </div>
  <form id="spec_form" method="post" enctype="multipart/form-data">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="s_sort"><em>*</em><?php echo $lang['sys_sort'];?></label>
        </dt>
        <dd class="opt">
