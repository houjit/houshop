      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="handle"><?php if($v['sg_id'] == '1'){ ?>
            ...
            <?php }else { ?>
            <a class="btn red" href="javascript:if(confirm('<?php echo $lang['problem_del'];?>'))window.location = 'index.php?app=store_grade&feiwa=store_grade_del&sg_id=<?php echo $v['sg_id'];?>';"><i class="fa fa-trash-o"></i><?php echo $lang['sys_del'];?></a>
            <?php } ?>
        ...
        <?php }else { ?>
        <tr class="no-data">
          <td colspan="100" class="no-data"><i class="fa fa-lightbulb-o"></i><?php echo $lang['sys_no_record'];?></td>
        </tr>
        <?php } ?>
      </tbody>
    </table>
