...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=goods_recommend&feiwa=get_xml',
        colModel : [
...
function fg_operate(name, bDiv) {
    if (name == 'del') {
    	...
    	window.location.href = 'index.php?app=goods_recommend&feiwa=add';
    }
}
...
function fg_delete(id) {
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: "index.php?app=goods_recommend&feiwa=delete",
        data: "del_id="+id,
