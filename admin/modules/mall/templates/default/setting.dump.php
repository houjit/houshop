...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_mall_set'];?></h3>
        <h5><?php echo $lang['sys_mall_set_subhead'];?></h5>
      </div>
  ...
  <form method="post" id="settingForm" name="settingForm">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="guest_comment_enable" class="cb-enable <?php if($output['list_setting']['guest_comment'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_yes'];?>"><?php echo $lang['sys_yes'];?></label>
            <label for="guest_comment_disabled" class="cb-disable <?php if($output['list_setting']['guest_comment'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_no'];?>"><?php echo $lang['sys_no'];?></label>
