          ...
          <dd class="opt">
            <div class="full-screen-slides">
              <ul>
                ...
                <div class="title"><h4>广告调用</h4><a class="ncap-btn-mini del" href="JavaScript:del_screen(<?php echo $val['pic_id'];?>);" title="<?php echo $lang['sys_del'];?>"><i class="fa fa-trash"></i>删除</a></div>
        ...
        <dl class="row">
          ...
          <dd class="opt focus-trigeminy">
              ...
              <div focus_id="<?php echo $key;?>" class="focus-trigeminy-group" title="<?php echo '可上下拖拽更改图片组显示顺序';?>">
                ...
                <div class="title"><h4>广告调用</h4><a class="ncap-btn-mini del" href="JavaScript:del_focus(<?php echo $key;?>);" title="<?php echo $lang['sys_del'];?>"><i class="fa fa-trash"></i>删除</a></div>
                <ul>
