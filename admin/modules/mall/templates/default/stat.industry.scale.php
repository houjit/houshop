...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      ...
      <input type="hidden" name="feiwa" value="scale" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?app=stat_industry&feiwa=scale_list&stattype='+type+'&t=<?php echo $output['searchtime'];?>&choose_gcid='+choose_gcid);
}
</script>