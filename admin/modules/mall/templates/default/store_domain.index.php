  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?app=domain&feiwa=store_domain_setting"><?php echo $lang['sys_config'];?></a></li>
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['sys_domain_mall'];?></a></li>
      </ul>
    </div>
  </div>
