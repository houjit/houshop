...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=sns_sharesetting" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_binding_manage'];?> - 编辑“<?php echo $output['edit_arr']['name'];?>”</h3>
        <h5><?php echo $lang['sys_binding_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form method="post" name="settingForm">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="isuse_1" class="cb-enable <?php if($output['edit_arr']['isuse'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_open'];?>"><span><?php echo $lang['sys_open'];?></span></label>
            <label for="isuse_0" class="cb-disable <?php if($output['edit_arr']['isuse'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['sys_close'];?>"><span><?php echo $lang['sys_close'];?></span></label>
      ...
      <?php }?>
      <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" onclick="document.settingForm.submit()"><?php echo $lang['sys_submit'];?></a> </div>
    </div>
  </form>
</div>
