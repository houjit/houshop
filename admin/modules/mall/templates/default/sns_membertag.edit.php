...
<div class="page">
  ...
  <form id="membertag_form" method="post" enctype="multipart/form-data">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label><?php echo $lang['sys_recommend'];?></label>
        </dt>
        <dd class="opt">
          <div class="onoff">
            <label for="mtag_recommend1" class="cb-enable <?php if($output['mtag_info']['mtag_recommend'] == 1){?>selected<?php }?>"><?php echo $lang['sys_yes'];?></label>
            <label for="mtag_recommend0" class="cb-disable <?php if($output['mtag_info']['mtag_recommend'] == 0){?>selected<?php }?>"><?php echo $lang['sys_no'];?></label>
      ...
      <dl class="row">
        <dt class="tit">
          <label for="mtag_sort"><?php echo $lang['sys_sort'];?></label>
        </dt>
        <dd class="opt">
