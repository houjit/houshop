...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_statgeneral'];?></h3>
        <h5>商城统计最新情报及相关设置</h5>
      </div>
  ...
  <form method="post" action="index.php" name="pricerangeform" id="pricerangeform">
    ...
    <div class="ncap-form-default">
        ...
        <dd class="opt" id="pricerang_table">
          <ul class="ncap-ajax-add">
            ...
            <li id="row_<?php echo $k; ?>">
              ...
              <label><a href="JavaScript:void(0);" onclick="delrow(<?php echo $k;?>);" class="ncap-btn ncap-btn-red"><?php echo $lang['sys_del']; ?></a></label>
            </li>
            <?php } ?>
            <?php } ?>
      ...
      <div class="bot"><a id="ncsubmit" class="ncap-btn-big ncap-btn-green" href="JavaScript:void(0);"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
...
$(function(){
	...
	$('#addrow').click(function(){
		...
		html += '<label><a href="JavaScript:void(0);" onclick="delrow('+i+');" class="ncap-btn ncap-btn-red"><?php echo $lang['sys_del']; ?></a></label></li>';
