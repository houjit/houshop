          ...
          <div class="layout-box">
            <dl>
              ...
              <dd><label><select class="s-select" name="keyword_type">
                <option selected="selected" value=""><?php echo $lang['sys_please_choose'];?></option>
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?app=vr_order&feiwa=get_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
    });
    // 高级搜索重置
    $('#ncreset').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?app=vr_order&feiwa=get_xml'}).flexReload();
        $("#formSearch")[0].reset();
    });
    $("#flexigrid").flexigrid({
        url: 'index.php?app=vr_order&feiwa=get_xml',
        colModel : [
...
function fg_cancel(id) {
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: "index.php?app=vr_order&feiwa=change_state&state_type=cancel",
        data: "order_id="+id,
