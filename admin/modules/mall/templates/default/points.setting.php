...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_member_pointsmanage']?></h3>
        <h5><?php echo $lang['sys_member_pointsmanage_subhead']?></h5>
      </div>
  ...
  <form method="post" name="settingForm" id="settingForm">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">邀请注册</dt>
        <dd class="opt">
          <input id="points_invite" name="points_invite" value="<?php echo $output['list_setting']['points_invite'];?>" class="input-txt" type="text">
        </dd>
      </dl>
      <div class="title">
