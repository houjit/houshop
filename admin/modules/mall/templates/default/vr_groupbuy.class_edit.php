...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?app=vr_groupbuy&feiwa=class_edit">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot">
        ...
        <a id="submit" href="javascript:void(0)" class="ncap-btn-big ncap-btn-green"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
