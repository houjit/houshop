  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="<?php echo urlAdminMall('rechargecard', 'log_list'); ?>">明细</a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
...
$(function() {
    var flexUrl = 'index.php?app=rechargecard&feiwa=index_xml';
        ...
        buttons: [
            {
                ...
                title: '添加新数据到列表',
                onpress: function() {
                    location.href = '<?php echo urlAdminMall('rechargecard', 'add_card'); ?>';
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    location.href = qs+'&app=rechargecard&feiwa=export_step1&ids=' + ids.join(',');
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    var href = '<?php echo urlAdminMall('rechargecard', 'del_card', array(
                        'id' => '__ids__',
