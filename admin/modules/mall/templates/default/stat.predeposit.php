...
function update_flex(){
	$('.ncap-stat-general-single').load('index.php?app=stat_trade&feiwa=get_plat_predeposit&'+$("#formSearch").serialize(),
		function(){
			$('.timer').each(count);
     	});
	$('#container').load('index.php?app=stat_trade&feiwa=get_predeposit_highcharts&'+$("#formSearch").serialize());
    $("#flexigrid").flexigrid({
        url: 'index.php?app=stat_trade&feiwa=get_predeposit_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?app=stat_trade&feiwa=predeposit';
