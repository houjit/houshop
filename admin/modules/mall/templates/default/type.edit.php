...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=type&feiwa=type" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_type_manage'];?> - <?php echo $lang['sys_edit'];?>“<?php echo $output['type_info']['type_name'];?>”</h3>
        <h5><?php echo $lang['sys_type_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  ...
  <form id="type_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div id="gcategory">
            ...
            <input class="edit_gcategory" type="button" value="<?php echo $lang['sys_edit'];?>">
            <?php }?>
      ...
      <dl class="row">
        <dt class="tit">
          <label for="t_sort"><em>*</em><?php echo $lang['sys_sort'];?></label>
        </dt>
        <dd class="opt">
        ...
        <dd class="opt">
          ...
          <div id="spec_div" class="scrollbar-box">
            <div class="ncap-type-spec-list">
              ...
              <?php }?>
              <?php }else{?>
              <div><?php echo $lang['type_add_spec_null_one'];?><a href="JavaScript:void(0);" onclick="window.parent.openItem('mall|spec')"><?php echo $lang['sys_spec_manage'];?></a><?php echo $lang['type_add_spec_null_two']?></div>
              <?php }?>
            </div>
          </div>
        </dd>
        ...
        <dd class="opt">
          ...
          <div id="brand_div" class="scrollbar-box">
            <div class="ncap-type-spec-list">
              ...
              <?php }?>
              <?php }else{?>
              <div><?php echo $lang['type_add_brand_null_one'];?><a href="JavaScript:void(0);" onclick="window.parent.openItem('mall|brand')"><?php echo $lang['sys_brand_manage'];?></a><?php echo $lang['type_add_brand_null_two']?></div>
              <?php }?>
            </div>
          </div>
        </dd>
      ...
      <dl class="row">
        <dt class="tit"><?php echo $lang['type_add_attr_add'].$lang['sys_colon'];?></dt>
        <dd class="opt">
          <ul class="ncap-ajax-add" id="ul_attr">
            ...
            <li>
              ...
              <label title="<?php echo $lang['sys_sort'];?>">
              ...
              <label> <?php echo $lang['sys_display'];?>
              ...
              <label><a href="javascript:void(0);" onclick="ajax_form('attr_deit', '编辑属性', '<?php echo urlAdminMall('type', 'attr_edit', array('attr_id' => $aval['attr_id']));?>', 640)" class="ncap-btn"><?php echo $lang['sys_edit'];?></a></label>
            </li>
            <?php }?>
            <?php }?>
      ...
      <div class="bot"><a id="submitBtn" class="ncap-btn-big ncap-btn-green" href="JavaScript:void(0);"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
...
$(function(){
    ...
    var ul_attr = '<li>' +
        ...
        '<label title="<?php echo $lang['sys_sort'];?>"><input type="text" class="w30" name="at_value[key][sort]" value="0" /></label>' +
        ...
        '<label><?php echo $lang['sys_display'];?>&nbsp;<input type="checkbox" checked="checked" name="at_value[key][show]" value="1" /></label>' +
