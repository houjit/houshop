...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_voucher_price_manage'];?></h3>
        <h5><?php echo $lang['sys_voucher_price_manage_subhead'];?></h5>
      </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=voucher&feiwa=pricelist_xml',
        colModel: [
        ...
        buttons: [
            {
                ...
                title: '添加一条新数据到列表',
                onpress: function() {
                    location.href = '<?php echo urlAdminMall('voucher', 'priceadd'); ?>';
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    location.href = '<?php echo urlAdminMall('voucher', 'pricedrop', array(
