...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_binding_manage'];?></h3>
  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle-s">
          <a class="btn blue" href="index.php?app=sns_sharesetting&feiwa=edit&state=1&key=<?php echo $k; ?>"><i class="fa fa-pencil-square-o"></i> <?php echo $lang['sys_edit']?></a></td>
