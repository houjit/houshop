...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <div class="subject">
        <h3><?php echo $lang['activity_index_manage'];?> - <?php echo $lang['sys_new'];?></a></h3>
  ...
  <form id="add_form" method="post" enctype="multipart/form-data">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="submitBtn"><span><?php echo $lang['sys_submit'];?></span></a></div>
    </div>
  </form>
</div>
<script>
