  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="<?php echo urlAdminMall('delivery', 'index');?>"><?php echo $lang['sys_manage'];?></a></li>
...
快递公司</a></p>
      ...
      <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['sys_submit'];?></a></div></div>
  </form>
</div>
<script>
$(function(){
