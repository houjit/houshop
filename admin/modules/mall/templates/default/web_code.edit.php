...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=web_config&feiwa=web_config" title="返回<?php echo '板块区';?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        ...
        <h5><?php echo $lang['sys_web_index_subhead'];?></h5>
      </div>
    </div>
  </div>
  <!-- 操作说明 -->
  ...
  <div class="ncap-form-all">
    ...
    <dl class="row">
      <dt class="tit">
        <label><?php echo $lang['web_config_edit_html'].$lang['sys_colon'];?></label>
      </dt>
      <dd class="opt">
          ...
          <div class="left">
            <dl id="left_tit">
              <dt>
                ...
                <a href="JavaScript:show_dialog('upload_tit');"><i class="fa fa-pencil-square-o"></i><?php echo $lang['sys_edit'];?></a></dt>
              ...
              <dt>
                ...
                <a href="JavaScript:show_dialog('upload_act');"><i class="fa fa-picture-o"></i><?php echo $lang['sys_edit'];?></a></dt>
              <dd class="act-pic">
            ...
            <dl>
              <dt>
                ...
                <a href="JavaScript:show_dialog('category_list');"><i class="icon-th"></i><?php echo $lang['sys_edit'];?></a></dt>
            ...
            <dl>
              <dt>
                ...
                <a href="JavaScript:show_dialog('brand_list');"><i class="icon-ticket"></i><?php echo $lang['sys_edit'];?></a></dt>
              <dd>
                <ul class="brands">
            ...
            <div>
              ...
              <dl recommend_id="<?php echo $key;?>">
                <dt>
                  ...
                  <a href="JavaScript:del_recommend(<?php echo $key;?>);"><i class="fa fa-trash"></i><?php echo $lang['sys_del'];?></a> <a href="JavaScript:show_recommend_dialog(<?php echo $key;?>);"><i class="fa fa-mallping-cart"></i><?php echo '商品块';?></a> <a href="JavaScript:show_recommend_pic_dialog(<?php echo $key;?>);"><i class="icon-lightbulb"></i><?php echo '广告块';?></a> </dt>
                <dd>
          ...
          <div class="feiwa-topbanner">
            ...
            <dl>
              <dt>
                ...
                <a href="JavaScript:show_dialog('upload_adv');"><?php echo $lang['sys_edit'];?></a></dt>
              <dd class="adv-pic">
...
<div id="upload_tit_dialog" style="display:none;">
  ...
  <form id="upload_tit_form" name="upload_tit_form" enctype="multipart/form-data" method="post" action="index.php?app=web_config&feiwa=upload_pic" target="upload_pic">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit"><?php echo $lang['web_config_upload_type'].$lang['sys_colon'];?></dt>
        <dd class="opt">
      ...
      <dl id="upload_tit_type_pic" class="row" <?php if($output['code_tit']['code_info']['type'] == 'txt'){ ?>style="display:none;"<?php } ?>>
        <dt class="tit"><?php echo $lang['web_config_upload_tit'].$lang['sys_colon'];?></dt>
        <dd class="opt">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_tit_form').submit();" class="ncap-btn-big ncap-btn-green"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
<!-- 推荐分类模块 -->
      ...
      <dl class="row">
        ...
        <dd class="opt"><div class="search-bar">商品分类：
          <select name="gc_parent_id" id="gc_parent_id" onchange="get_goods_class();">
            <option value="0"><?php echo $lang['sys_please_choose'];?></option>
...
<div id="upload_act_dialog" class="upload_act_dialog" style="display:none;">
  ...
  <form id="upload_act_form" name="upload_act_form" enctype="multipart/form-data" method="post" action="index.php?app=web_config&feiwa=upload_pic" target="upload_pic">
    ...
    <div class="ncap-form-default" id="upload_act_type_pic" <?php if($output['code_act']['code_info']['type'] == 'adv') { ?>style="display:none;"<?php } ?>>
      ...
      <dl class="row">
        <dt class="tit">
          <label><?php echo $lang['web_config_upload_url'].$lang['sys_colon'];?></label>
        </dt>
        <dd class="opt">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_act_form').submit();" class="ncap-btn-big ncap-btn-green"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
<!-- 商品推荐模块 -->
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="search-bar">
            ...
            <a href="JavaScript:void(0);" onclick="get_recommend_goods();" class="ncap-btn"><?php echo $lang['sys_query'];?></a></div>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="search-bar">
            ...
            <a href="JavaScript:void(0);" onclick="get_recommend_brand();" class="ncap-btn"><?php echo $lang['sys_query'];?></a> </div>
...
<div id="upload_adv_dialog" class="upload_adv_dialog" style="display:none;">
  ...
  <form id="upload_adv_form" name="upload_adv_form" enctype="multipart/form-data" method="post" action="index.php?app=web_config&feiwa=slide_adv" target="upload_pic">
    ...
    <div id="upload_slide_adv" class="ncap-form-default" style="display:none;">
      ...
      <dl class="row">
        <dt class="tit"><?php echo $lang['web_config_upload_adv_pic'].$lang['sys_colon'];?></dt>
        <dd class="opt">
          <div class="input-file-show"><span class="type-file-box">
            <input type='text' name='textfield' id='textfield1' class='type-file-text' />
            <input type='button' name='button' id='button1' value='选择上传...' class='type-file-button' />
