...
<script>
$(function(){
    var flexUrl = 'index.php?app=activity&feiwa=activity_xml';
        ...
        buttons: [
            {
                ...
                title: '平台发起新活动',
                onpress: function() {
                    location.href = 'index.php?app=activity&feiwa=new';
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    var href = 'index.php?app=activity&feiwa=del&activity_id=__IDS__'.replace('__IDS__', ids.join(','));
...
$("span[data-live-inline-edit='activity_sort']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.get('index.php?app=activity&feiwa=ajax&branch=activity_sort', {
...
$("span[data-live-inline-edit='activity_title']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.get('index.php?app=activity&feiwa=ajax&branch=activity_title', {
            id: $this.parents('tr').attr('data-id'),
