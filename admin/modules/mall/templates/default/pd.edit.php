...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=predeposit&feiwa=predeposit" title="返回充值管理列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_member_predepositmanage'];?> - 处理预存款充值</h3>
        <h5><?php echo $lang['sys_member_predepositmanage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form method="post" name="form1" id="form1" action="index.php?app=predeposit&feiwa=recharge_edit&id=<?php echo intval($_GET['id']);?>">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" id="ncsubmit" class="ncap-btn-big ncap-btn-green"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
