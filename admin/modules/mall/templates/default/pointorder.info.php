    ...
    <div class="ncap-order-details">
      ...
      <div class="tabs-panels">
        <div class="misc-info">
          ...
          <dl>
            <dt><?php echo $lang['admin_pointorder_ordersn'];?><?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo $output['order_info']['point_ordersn'];?></dd>
            <dt><?php echo $lang['admin_pointorder_orderstate'];?><?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo $output['order_info']['point_orderstatetext']; ?></dd>
            <dt><?php echo $lang['admin_pointorder_addtime'];?><?php echo $lang['sys_colon'];?></dt>
        ...
        <div class="addr-note">
          <h4>购买/收货方信息</h4>
          <dl>
            <dt><?php echo $lang['admin_pointorder_membername'];?><?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo $output['order_info']['point_buyername'];?></dd>
            <dt><?php echo $lang['admin_pointorder_info_memberemail']; ?><?php echo $lang['sys_colon'];?></dt>
          ...
          <dl>
            <dt><?php echo $lang['admin_pointorder_info_ordermessage']; ?><?php echo $lang['sys_colon'];?></dt>
        ...
        <div class="contact-info">
          <h4>发货信息</h4>
          <dl>
            <dt>物流公司<?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo $output['express_info']['e_name']; ?></dd>
            <dt><?php echo $lang['admin_pointorder_shipping_code'];?><?php echo $lang['sys_colon'];?></dt>
            <dd><?php echo $output['order_info']['point_shippingcode']; ?></dd>
            <dt><?php echo $lang['admin_pointorder_shipping_time'];?><?php echo $lang['sys_colon'];?></dt>
        ...
        <div class="goods-info">
          ...
          <div class="total-amount">
            <h3><?php echo $lang['admin_pointorder_exchangepoints'];?><?php echo $lang['sys_colon'];?><strong class="red_common"><?php echo $output['order_info']['point_allpoint'];?></strong></h3>
            <?php if ($output['order_info']['point_shippingcharge'] == 1){ ?>
            <h4>(<?php echo $lang['admin_pointorder_shippingfee'];?><?php echo $lang['sys_colon'];?><?php echo $output['order_info']['point_shippingfee'];?>)</h4>
            <?php } ?>
          </div>
        </div>
      </div>
