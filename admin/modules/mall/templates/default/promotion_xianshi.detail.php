...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    <div class="title" id="checkZoom"><i class="fa fa-lightbulb-o"></i>
      <h4 title="<?php echo $lang['sys_prompts_title'];?>">活动规则</h4>
    ...
    <ul>
      ...
      <li> <?php echo $lang['sys_state'].'：'.$output['xianshi_info']['xianshi_state_text'];?> </li>
    </ul>
  </div>
  <!-- 列表 -->
      ...
      <tbody id="treet1">
        ...
        <tr>
          ...
          <td class="yes-onoff"><?php if($val['xianshi_recommend']){ ?>
            <a href="JavaScript:void(0);" class=" enabled" ajax_branch='recommend' feiwa_type="inline_edit" fieldname="xianshi_recommend" fieldid="<?php echo $val['xianshi_goods_id']?>" fieldvalue="1" title="<?php echo $lang['sys_editable'];?>"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
            <?php }else { ?>
            <a href="JavaScript:void(0);" class=" disabled" ajax_branch='recommend' feiwa_type="inline_edit" fieldname="xianshi_recommend" fieldid="<?php echo $val['xianshi_goods_id']?>" fieldvalue="0" title="<?php echo $lang['sys_editable'];?>"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
            <?php } ?></td>
          <?php } ?>
          <td></td>
        </tr>
