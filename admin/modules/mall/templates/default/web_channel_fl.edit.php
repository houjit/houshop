        ...
        <div class="channel-templates-board-layout">
          <div class="left">
            <dl id="left_tit">
              <dt>
                <h4>模块标题</h4>
                <a href="JavaScript:show_dialog('channel_tit');"><i class="fa fa-pencil-square-o"></i><?php echo $lang['sys_edit'];?></a></dt>
              <dd class="tit-txt">
            ...
            <dl>
              <dt>
                ...
                <a href="JavaScript:show_dialog('upload_channel_act');"><i class="fa fa-picture-o"></i><?php echo $lang['sys_edit'];?></a></dt>
              <dd class="act-pic">
            ...
            <div>
              ...
              <dl recommend_id="<?php echo $key;?>">
                <dt>
                  ...
                  <a href="JavaScript:del_recommend(<?php echo $key;?>);"><i class="fa fa-trash"></i><?php echo $lang['sys_del'];?></a> <a href="JavaScript:show_recommend_dialog(<?php echo $key;?>);"><i class="fa fa-mallping-cart"></i><?php echo '商品块';?></a></dt>
                <dd>
          ...
          <div class="right">
            <dl>
              <dt>
                <h4>广告图片1</h4>
                <a href="JavaScript:show_dialog('upload_adv_a');"><i class="fa fa-picture-o"></i><?php echo $lang['sys_edit'];?></a></dt>
              <dd class="adv-pic">
            ...
            <dl>
              <dt>
                <h4>广告图片2</h4>
                <a href="JavaScript:show_dialog('upload_adv_b');"><i class="fa fa-picture-o"></i><?php echo $lang['sys_edit'];?></a></dt>
              <dd class="adv-pic">
            ...
            <dl>
              <dt>
                <h4>广告图片3</h4>
                <a href="JavaScript:show_dialog('upload_adv_c');"><i class="fa fa-picture-o"></i><?php echo $lang['sys_edit'];?></a></dt>
              <dd class="adv-pic">
...
<div id="channel_tit_dialog" style="display:none;">
  <form id="channel_tit_form" name="channel_tit_form">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="update_channel_tit();" class="ncap-btn-big ncap-btn-green"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
<!-- 活动图片 -->
<div id="upload_channel_act_dialog" class="upload_channel_act_dialog" style="display:none;">
  <form id="upload_channel_act_form" name="upload_channel_act_form" enctype="multipart/form-data" method="post" action="index.php?app=web_channel&feiwa=upload_pic" target="upload_pic">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_channel_act_form').submit();" class="ncap-btn-big ncap-btn-green"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
<!-- 商品推荐模块 -->
