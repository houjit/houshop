...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_message_set'];?></h3>
    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="handle-s"><a class="btn blue" href="<?php echo urlAdminMall('message', 'member_tpl_edit', array('code' => $val['mmt_code']));?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['sys_edit'];?></a></td>
