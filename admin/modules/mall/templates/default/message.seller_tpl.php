    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="handle-s"><a class="btn blue" href="<?php echo urlAdminMall('message', 'seller_tpl_edit', array('code' => $val['smt_code']));?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['sys_edit'];?></a></td>
