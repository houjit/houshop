      ...
      <dl class="row">
        ...
        <dd class="opt">
          <table border="1" cellpadding="3" cellspacing="3" bordercolor="#CCC">
            <tbody>
              <tr>
                <td bgcolor="#EFF8F8"><?php echo $lang['sys_sort'];?></td>
          ...
          <p class="notic"><a href="#/thread-4-1-1.html" class="ncap-btn" target="_blank"><?php echo $lang['goods_class_import_example_tip'];?></a></p>
        </dd>
      </dl>
