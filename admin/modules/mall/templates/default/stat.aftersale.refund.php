...
function update_flex(){
	$('#container').load('index.php?app=stat_aftersale&feiwa=get_refund_highcharts&'+$("#formSearch").serialize());
    $("#flexigrid").flexigrid({
        url: 'index.php?app=stat_aftersale&feiwa=get_refundlist_xml&'+$("#formSearch").serialize(),
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?app=stat_aftersale&feiwa=refundlist';
