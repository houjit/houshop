...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_shareshow_comment_manage'];?></h3>
        <h5><?php echo $lang['sys_shareshow_comment_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <!-- 操作说明 -->
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['shareshow_comment_tip1'];?></li>
    </ul>
  </div>
...
<script>
$(function() {
    var flexUrl = 'index.php?app=comment&feiwa=comment_manage_xml';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?app=comment&feiwa=comment_drop&comment_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ],
        searchitems: [
