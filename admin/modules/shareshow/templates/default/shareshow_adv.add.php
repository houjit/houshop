...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=adv&feiwa=adv_manage" title="返回广告列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_shareshow_adv_manage'];?> - 新增/编辑广告条<?php if(isset($output['adv_info']['adv_name'])) echo $output['adv_info']['adv_name'];?></h3>
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?app=adv&feiwa=adv_save">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="adv_sort"><em>*</em><?php echo $lang['sys_sort'];?></label>
        </dt>
        <dd class="opt">
