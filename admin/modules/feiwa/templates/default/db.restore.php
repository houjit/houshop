     ...
     <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="350" align="left"><?php echo $lang['sys_handle'];?></th>
        ...
        <span class="btn"><em><i class="fa fa-cog"></i>设置<i class="arrow"></i></em>
            <ul><li><a href="javascript:if(confirm('<?php echo $lang['sys_ensure_del'];?>')){location.href='index.php?app=db&feiwa=db_del&dir_name=<?php echo $v['name'];?>'};"><?php echo $lang['sys_del'];?></a></li>
