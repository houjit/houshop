...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=reads_navigation&feiwa=reads_navigation_list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_reads_navigation_manage'];?> - <?php echo $lang['sys_new'];?></h3>
        <h5><?php echo $lang['sys_reads_navigation_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="add_form" method="post" action="index.php?app=reads_navigation&feiwa=reads_navigation_save">
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="navigation_title"><em>*</em><?php echo $lang['reads_navigation_name'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="navigation_link"><em>*</em><?php echo $lang['reads_navigation_url'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="navigation_sort"><em>*</em><?php echo $lang['sys_sort'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="navigation_open_type"><em>*</em><?php echo $lang['reads_navigation_open_type'];?></label>
        </dt>
        <dd class="opt">
          <div class="onoff">
            <label for="isuse_1" class="cb-enable selected" title="<?php echo $lang['sys_yes'];?>"><?php echo $lang['sys_yes'];?></label>
            <label for="isuse_0" class="cb-disable" title="<?php echo $lang['sys_no'];?>"><?php echo $lang['sys_no'];?></label>
