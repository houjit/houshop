  ...
  <form method="post" id="db_form">
    <input type="hidden" name="form_submit" value="ok" />
     <div class="ncap-form-all">
      ...
      <dt class="tit"><span>选择需要备份的表</span></dt>
        <dd class="opt nobg nopd nobd nobs">
          <div class="ncap-account-container">
            ...
            &nbsp;
            <label for="checkall"><?php echo $lang['sys_select_all'];?></label>
            </h4>
      ...
      </dl><div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="btn"><?php echo $lang['sys_submit'];?></a></div></div>
  </form>
</div>
<script>
