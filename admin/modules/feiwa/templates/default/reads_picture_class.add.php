...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=reads_picture_class&feiwa=reads_picture_class_list" title="返回画报分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_reads_picture_class'];?> - <?php echo $lang['sys_new'];?></h3>
        <h5><?php echo $lang['sys_reads_picture_class_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="add_form" method="post" action="index.php?app=reads_picture_class&feiwa=reads_picture_class_save">
