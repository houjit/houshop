...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=document&feiwa=document" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['document_index_document'];?> - <?php echo $lang['sys_edit'];?>文章“<?php echo $output['doc']['doc_title'];?>”</h3>
          ...
          <div id="thumbnails" class="ncap-thumb-list">
            ...
            <ul>
              ...
              <li id="<?php echo $v['upload_id'];?>">
                ...
                <a href="javascript:del_file_upload('<?php echo $v['upload_id'];?>');" class="del" title="<?php echo $lang['sys_del'];?>">X</a><a href="javascript:insert_editor('<?php echo $v['upload_path'];?>');" class="inset"><i class="fa fa-clipboard"></i>插入图片</a> </li>
              <?php } ?>
              <?php } ?>
            </ul>
          </div>
