    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="handle-s"><a class="btn blue" href="index.php?app=message&feiwa=email_tpl_edit&code=<?php echo $v['code']; ?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['sys_edit'];?></a></td>
