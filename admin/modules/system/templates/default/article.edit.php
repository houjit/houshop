...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=article&feiwa=article" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['article_index_manage'];?> - <?php echo $lang['sys_edit'];?>文章“<?php echo $output['article_array']['article_title'];?>”</h3>
  ...
  <form id="article_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="article_show1" class="cb-enable <?php if($output['article_array']['article_show'] == '1'){ ?>selected<?php } ?>" ><?php echo $lang['sys_yes'];?></label>
            <label for="article_show0" class="cb-disable <?php if($output['article_array']['article_show'] == '0'){ ?>selected<?php } ?>" ><?php echo $lang['sys_no'];?></label>
      ...
      <dl class="row">
        <dt class="tit"><?php echo $lang['sys_sort'];?></dt>
        <dd class="opt">
          ...
          <div id="thumbnails" class="ncap-thumb-list">
            ...
            <ul>
              ...
              <li id="<?php echo $v['upload_id'];?>">
                ...
                <a href="javascript:del_file_upload('<?php echo $v['upload_id'];?>');" class="del" title="<?php echo $lang['sys_del'];?>">X</a><a href="javascript:insert_editor('<?php echo $v['upload_path'];?>');" class="inset"><i class="fa fa-trash"></i>插入图片</a> </li>
              <?php } ?>
              <?php } ?>
            </ul>
          </div>
...
{
    if(!window.confirm('<?php echo $lang['sys_ensure_del'];?>')){
        return;
    }
