...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=article&feiwa=article" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['article_index_manage'];?> - <?php echo $lang['sys_new'];?>文章</h3>
  ...
  <form id="article_form" method="post" name="articleForm">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="article_show1" class="cb-enable selected" ><?php echo $lang['sys_yes'];?></label>
            <label for="article_show0" class="cb-disable" ><?php echo $lang['sys_no'];?></label>
