    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="100" align="center"><?php echo $lang['sys_sort'];?></th>
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $v['nav_id'];?>">
          ...
          <td class="handle"><a href="javascript:submit_delete(<?php echo $v['nav_id'];?>);" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['sys_del'];?></a>
          <a class="btn blue" href="index.php?app=navigation&feiwa=navigation_edit&nav_id=<?php echo $v['nav_id'];?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['sys_edit'];?></a>
          </td>
          <td class="sort"><span feiwa_type="tag_sort" column_id="<?php echo $v['nav_id'];?>" title="<?php echo $lang['sys_editable'];?>" class="editable "><?php echo $v['nav_sort'];?></span></td>
...
$(document).ready(function(){
    ...
    //行内ajax编辑
    $('span[feiwa_type="tag_sort"]').inline_edit({app: 'navigation',op: 'ajax'});
    $('span[feiwa_type="tag_name"]').inline_edit({app: 'navigation',op: 'ajax'});
});
