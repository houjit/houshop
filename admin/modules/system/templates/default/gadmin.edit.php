...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=admin&feiwa=gadmin" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_limit_manage'];?> - <?php echo $lang['sys_edit'];?>权限组“<?php echo $output['ginfo']['gname'];?>”</h3>
  ...
  <form id="add_form" method="post" name="adminForm" style="margin-bottom: 50px;">
    ...
    <div class="ncap-form-all">
      ...
      <?php } ?>
      <div class="fix-bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" onclick="document.adminForm.submit()"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
<script>
...
$(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
            gname : {
                required : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['sys_none_input'];?>',
