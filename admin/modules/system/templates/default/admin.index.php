...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_limit_manage'];?></h3>
    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <a class="btn blue" href="index.php?app=admin&feiwa=admin_edit&admin_id=<?php echo $v['admin_id']; ?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['sys_edit'];?></a>
          <?php } else { ?>
          <span>--</span>
          <?php } ?>
          </td>
