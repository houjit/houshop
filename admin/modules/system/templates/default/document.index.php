  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle-s"><a class="btn blue" href="index.php?app=document&feiwa=edit&doc_id=<?php echo $v['doc_id']; ?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['sys_edit'];?></a></td>
