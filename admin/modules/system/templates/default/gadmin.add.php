...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=admin&feiwa=gadmin" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_limit_manage'];?> - <?php echo $lang['sys_add'];?>权限组</h3>
  ...
  <form id="add_form" method="post" style="margin-bottom: 50px;">
    ...
    <div class="ncap-form-all">
      ...
      <?php } ?>
      <div class="fix-bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
<script>
