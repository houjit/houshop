...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=navigation&feiwa=navigation" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['navigation_index_nav'];?> - <?php echo $lang['sys_edit'];?>”<?php echo $output['navigation_array']['nav_title'];?>“</h3>
  ...
  <form id="navigation_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="nav_new_open1" class="cb-enable <?php if($output['navigation_array']['nav_new_open'] == '1'){ ?>selected<?php } ?>" ><?php echo $lang['sys_yes'];?></label>
            <label for="nav_new_open0" class="cb-disable <?php if($output['navigation_array']['nav_new_open'] == '0'){ ?>selected<?php } ?>" ><?php echo $lang['sys_no'];?></label>
      ...
      <dl class="row">
        <dt class="tit">
          <label for="nav_sort"><?php echo $lang['sys_sort'];?></label>
        </dt>
        <dd class="opt">
