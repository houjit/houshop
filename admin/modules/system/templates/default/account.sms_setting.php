...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      ...
      <li>短信接口配置请前往“运营-运营控件-短信设置”进行相关配置，提供<a href="#" target="_blank">短信接口</a>  <a href="http://www.smsbao.com/reg?r=10603" target="_blank">短信宝短信接口</a>  <a href="https://www.yunpian.com/component/reg?inviteCode=bwqrby" target="_blank">云片短信接口</a>。</li>
    </ul>
  </div>
