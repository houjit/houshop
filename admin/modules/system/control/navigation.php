...
class navigationControl extends SystemControl{
    ...
    public function indexFeiwa() {
        $this->navigationFeiwa();
    }

    /**
     * 页面导航
     */
    public function navigationFeiwa(){
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $url = array(
                        array(
                            'url'=>'index.php?app=navigation&feiwa=navigation_add',
                            'msg'=>$lang['navigation_add_again'],
                        ),
                        array(
                            'url'=>'index.php?app=navigation&feiwa=navigation',
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $url = array(
                        array(
                            'url'=>'index.php?app=navigation&feiwa=navigation_edit&nav_id='.intval($_POST['nav_id']),
    ...
    public function navigation_delFeiwa(){
        ...
        if (preg_match('/^[\d,]+$/', $_GET['nav_id'])) {
            ...
            showMessage($lang['navigation_index_del_succ'],'index.php?app=navigation&feiwa=navigation');
        }else {
            showMessage($lang['navigation_index_choose_del'],'index.php?app=navigation&feiwa=navigation');
        }
    }
