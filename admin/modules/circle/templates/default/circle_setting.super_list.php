...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_circle_setting'];?></h3>
        <h5><?php echo $lang['sys_circle_setting_subhead'];?></h5>
      </div>
      <ul class="tab-base nc-row">
        <li><a href="<?php echo urlAdminCircle('circle_setting', 'index');?>"><?php echo $lang['sys_circle_setting'];?></a></li>
    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="handle-s"><a href="javascript:void(0);" onclick="if(confirm('<?php echo $lang['sys_ensure_del'];?>')){location.href='<?php echo urlAdminCircle('circle_setting', 'del_super', array('member_id' => $val['member_id']));?>'}" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['sys_del'];?></a></td>
