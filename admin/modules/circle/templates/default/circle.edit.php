...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=circle_manage&feiwa=circle_list" title="返回圈子列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_circle_manage'];?> - <?php echo $output['circle_info']['circle_status'] == 2 ? '审核' : $lang['sys_edit'];?>圈子“<?php echo $output['circle_info']['circle_name'];?>”</h3>
        <h5><?php echo $lang['sys_circle_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="circle_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="c_recommend1" class="cb-enable <?php if($output['circle_info']['is_recommend'] == 1) echo 'selected';?>" ><?php echo $lang['sys_yes'];?></label>
            <label for="c_recommend0" class="cb-disable <?php if($output['circle_info']['is_recommend'] == 0) echo 'selected';?>" ><?php echo $lang['sys_no'];?></label>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="is_hot1" class="cb-enable <?php if($output['circle_info']['is_hot'] == 1) echo 'selected';?>" ><?php echo $lang['sys_yes'];?></label>
            <label for="is_hot0" class="cb-disable <?php if($output['circle_info']['is_hot'] == 0) echo 'selected';?>" ><?php echo $lang['sys_no'];?></label>
      ...
      <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['sys_submit'];?></a></div>
    </div>
  </form>
</div>
		...
		(
			{
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','<?php echo $lang['sys_cut'];?>','<?php echo ADMIN_SITE_URL?>/index.php?app=common&feiwa=pic_cut&type=circle&x=120&y=120&resize=1&ratio=1&filename=<?php echo UPLOAD_SITE_URL.'/'.ATTACH_CIRCLE;?>/group/<?php echo $_GET['c_id'];?>.jpg&url='+data.url,690);
					}else{
						alert(data.msg);
					}
