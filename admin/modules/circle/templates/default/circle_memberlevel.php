...
<div class="page">
  ...
  <form method="post" id="clmdForm" name="clmdForm">
    ...
    <div class="ncap-form-all">
      ...
      <div class="fix-bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['sys_submit'];?></a>  <a href="index.php?app=circle_memberlevel&feiwa=update_cache" class="ncap-btn-big ncap-btn-orange" ><?php echo $lang['sys_circle_cache'];?></a></div>
    </div>
  </form>
</div>
<script>
