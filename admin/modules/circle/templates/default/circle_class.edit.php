...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=circle_class&feiwa=class_list" title="返回分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_circle_classmanage'];?> - <?php echo $lang['sys_edit'];?>圈子分类“<?php echo $output['class_info']['class_name'];?>”</h3>
  ...
  <form id="class_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="recommend1" class="cb-enable <?php if($output['class_info']['is_recommend'] == '1'){?>selected<?php }?>" ><?php echo $lang['sys_yes'];?></label>
            <label for="recommend0" class="cb-disable <?php if($output['class_info']['is_recommend'] == '0'){?>selected<?php }?>" ><?php echo $lang['sys_no'];?></label>
      ...
      <dl class="row">
        <dt class="tit">
          <label for="class_sort"><?php echo $lang['sys_sort'];?></label>
        </dt>
        <dd class="opt">
