...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=circle_manage&feiwa=circle_list" title="返回圈子列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_circle_manage'];?> - <?php echo $lang['sys_new'];?>圈子</h3>
  ...
  <form id="circle_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="c_recommend1" class="cb-enable selected" ><?php echo $lang['sys_yes'];?></label>
            <label for="c_recommend0" class="cb-disable" ><?php echo $lang['sys_no'];?></label>
...
$(function(){
		...
		(
			{
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','<?php echo $lang['sys_cut'];?>','<?php echo ADMIN_SITE_URL?>/index.php?app=common&feiwa=pic_cut&type=circle&x=120&y=120&resize=1&ratio=1&url='+data.url,690);
					}else{
						alert(data.msg);
	...
	$('#mastername').focus(function(){
		ajax_form('choose_master', '<?php echo $lang['circle_choose_master'];?>', 'index.php?app=circle_manage&feiwa=choose_master', 640);
	});
	...
	$('#circle_form').validate({
        ...
        rules : {
        	c_name : {
        		...
        		maxlength : 12,
            	remote : {
            		url : 'index.php?app=circle_manage&feiwa=check_circle_name',
                    type: 'get',
                    data:{
                    	name : function(){
                            return $('#c_name').val();
            ...
            mastername : {
            	required : true,
                remote   : {
                    url :'index.php?app=circle_manage&feiwa=check_member&branch=ok',
                    type:'get',
                    data:{
                        name : function(){
