...
<div class="ncap-form-default">
  <dl class="row">
    <dt class="tit">
      <label for="searchname"><?php echo $lang['sys_member_name'];?></label>
    </dt>
    <dd class="opt">
      <input type="text" name="searchname" id="searchname" class="input-txt"/>
      <input type="submit" nctype="cm_s" value="<?php echo $lang['sys_search'];?>" class="input-btn" />
    </dd>
  </dl>
  <dl class="row">
    <dt class="tit">
      <label><?php echo $lang['sys_result'];?></label>
    </dt>
    <dd class="opt">
  ...
  <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="confirmBtn"><?php echo $lang['sys_ok'];?></a></div>
</div>
<script>
