...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=circle_class&feiwa=class_list" title="返回分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['sys_circle_classmanage'];?> - <?php echo $lang['sys_new'];?>圈子分类</h3>
  ...
  <form id="class_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="recommend1" class="cb-enable selected" ><?php echo $lang['sys_yes'];?></label>
            <label for="recommend0" class="cb-disable" ><?php echo $lang['sys_no'];?></label>
