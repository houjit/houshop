...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['sys_circle_informnamage'];?></h3>
        <h5><?php echo $lang['sys_circle_informnamage_subhead'];?></h5>
      </div>
    </div>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=circle_inform&feiwa=get_xml',
        colModel : [
...
function fg_del(ids) {
    ...
    if(confirm('删除后将不能恢复，确认删除这项吗？')){
        $.getJSON('index.php?app=circle_inform&feiwa=inform_del', {id:id}, function(data){
            if (data.state) {
