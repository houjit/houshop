  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle-s"><a href="<?php echo urlAdminMobile('mb_payment', 'payment_edit', array('payment_id' => $v['payment_id']));?>" class="btn purple"><i class="fa fa-cog"></i><?php echo $lang['sys_set']?></a></td>
