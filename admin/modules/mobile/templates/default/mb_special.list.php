    ...
    <table class="flex-table">
      ...
      <tbody id="treet1">
        ...
        <tr>
          ...
          <td class="name"><span feiwa_type="edit_special_desc" column_id="<?php echo $value['special_id'];?>" title="<?php echo $lang['sys_editable'];?>" class="editable tooltip w270"><?php echo $value['special_desc'];?></span></td>
          <td></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
...
$(function(){
	$('.flex-table').flexigrid({
        ...
        buttons : [
            {
                ...
                title : '新增专题',
                onpress : function() {
                    $('#dialog_add_mb_special').feiwa_show_dialog({title: '新增专题'});
                }
            }
        ]
    });
        ...
        //编辑专题描述
        $('span[feiwa_type="edit_special_desc"]').inline_edit({app: 'mb_special',feiwa: 'update_special_desc'});
    });
