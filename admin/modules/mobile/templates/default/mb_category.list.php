    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr class="edit">
          ...
          <td class="handle"><a href="javascript:if(confirm('<?php echo $lang['sys_ensure_del'];?>'))window.location = 'index.php?app=mb_category&feiwa=mb_category_del&gc_id=<?php echo $v['gc_id'];?>';" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['sys_del'];?></a><a href="index.php?app=mb_category&feiwa=mb_category_edit&gc_id=<?php echo $v['gc_id'];?>" class="btn blue"><i class="fa fa-pencil-square-o"></i><?php echo $lang['sys_edit'];?></a></td>
