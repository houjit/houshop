...
<div class="page">
  ...
  <form id="post_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"> <a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['sys_submit'];?></a><a href="index.php?app=mb_app&feiwa=mb_qr"  class="ncap-btn-big ncap-btn-orange ml10">生成二维码</a> </div>
    </div>
  </form>
</div>
<script>
