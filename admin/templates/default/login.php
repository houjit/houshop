...
<div class="login-layout">
  ...
  <form method="post" id="form_login">
    ...
    <div class="submit"> <span>
      <div class="code">
        <div class="arrow"></div>
        <div class="code-img"><img src="<?php echo $chk_code; ?>index.php?app=seccode&feiwa=makecode&admin=1&nchash=<?php echo getNchash();?>" name="codeimage" id="codeimage" border="0"/></div>
        <a href="JavaScript:void(0);" id="hide" class="close" title="<?php echo $lang['login_index_close_checkcode'];?>"><i></i></a><a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='<?php echo $chk_code; ?>index.php?app=seccode&feiwa=makecode&admin=1&nchash=<?php echo getNchash();?>&t=' + Math.random();" class="change" title="<?php echo $lang['login_index_change_checkcode'];?>"><i></i></a> </div>
  ...
  <div class="bottom">
    <h6><!--Copyright--><?php echo date('Y', time()); ?> </h6>
    <h6><!--Powered by testmall--></h6>
