...
<form action="index.php?app=common&feiwa=pic_cut" id="form_cut" method="post">
  ...
  <div class="pic-cut-<?php echo $_GET['x'].$_GET['type'];?>">
    <div class="work-title"><?php echo $lang['sys_comm_workarea'];?></div>
    <div class="work-layer">
      <p><img id="nccropbox" src="<?php echo $_GET['url'];?>"/></p>
    </div>
    <div class="thumb-title"><?php echo $lang['sys_comm_cut_view'];?></div>
    <div class="thumb-layer">
      <p><img id="preview" src="<?php echo $_GET['url'];?>"/></p>
    </div>
    <div class="cut-help">
      <h4><?php echo $lang['sys_comm_op_help'];?></h4>
      <p><?php echo $lang['sys_comm_op_help_tip'];?></p>
    </div>
    <div class="cut-btn"> <a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="pic_submit"><i class="fa fa-scissors"></i><?php echo $lang['sys_submit'];?></span></a> </div>
  </div>
</form>
