<?php defined('INSYSVIEW') or exit('Access Invalid!');?><?php echo getChat($layout);?><div class="feiwa-footer"> 
 <div class="ensureBox"> 
  <ul class="clearfix"> 
 ...
 <div class="gray_box"> 
  ...
  <div class="wrap"> 
   ...
   <div class="copy_right">
     <?php echo date('Y',time()); ?> © <span style="color:#0fcfe1;"><?php echo C('site_name');?></span> <?php echo $output['setting_config']['icp_number']; ?> <!--   客户服务中心(7×24):021-999999--><br />
   </div> 
  </div> 
 </div> 
