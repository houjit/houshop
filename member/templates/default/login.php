        ...
        <div id="default" class="tabs-content">
          <form id="login_form" class="nc-login-form" method="post" action="<?php echo urlLogin('login', 'index');?>">
            ...
            <div class="code-div mt15">
              ...
              <span><img src="<?php echo $chk_code; ?>index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>" name="codeimage" id="codeimage"> <a class="makecode" href="javascript:void(0)" onclick="javascript:document.getElementById('codeimage').src='<?php echo $chk_code; ?>index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_index_change_checkcode'];?></a></span></div>
            <?php } ?>
        ...
        <div id="mobile" class="tabs-content">
          <form id="post_form" method="post" class="nc-login-form" action="<?php echo urlLogin('connect_sms', 'login');?>">
            ...
            <div class="code-div">
              ...
              <span><img src="<?php echo $chk_code; ?>index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" id="sms_codeimage"> <a class="makecode" href="javascript:void(0);" onclick="javascript:document.getElementById('sms_codeimage').src='<?php echo $chk_code; ?>index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span> </div>
	...
	$("#login_form").validate({
		...
		rules: {
            ...
            ,captcha : {
                required : true,
                remote   : {
                    url : '<?php echo $chk_code; ?>index.php?app=seccode&feiwa=check&nchash=<?php echo getNchash();?>',
                    type: 'get',
                    data:{
                        captcha : function(){
                            return $('#captcha').val();
                    ...
                    complete: function(data) {
                        if(data.responseText == 'false') {
                        	document.getElementById('codeimage').src='<?php echo $chk_code; ?>index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();
                        }
                    }
                }
            }
		...
		rules: {
			...
			captcha : {
                ...
                remote   : {
                    ...
                    complete: function(data) {
                        if(data.responseText == 'false') {
                        	document.getElementById('sms_codeimage').src='<?php echo $chk_code; ?>index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();
                        }
                    }
                }
            },
