            ...
            <div id="default" class="tabs-content">
			  ...
			  <input type="hidden" id="rec_id" name="rec_id" class="text" value="<?php echo $_GET['rec'];?>"/>
                ...
                <div class="code-div mt15">
                  ...
                  <span><img src="<?php echo $chk_code; ?>index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>" name="codeimage" id="codeimage"/> <a class="makecode" href="javascript:void(0)" onclick="javascript:document.getElementById('codeimage').src='<?php echo $chk_code; ?>index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span></div>
                <?php } ?>
                <dl class="clause-div">
                  <dd>
