...
class member_informationControl extends BaseMemberControl {
    ...
    public function memberFeiwa() {
        ...
        if (chksubmit()){
            ...
            $message = $update? $lang['feiwa_common_save_succ'] : $lang['feiwa_common_save_fail'];
        ...
        Tpl::output('menu_sign_url','index.php?app=member_information&feiwa=member');
    ...
    public function moreFeiwa(){
        ...
        if(chksubmit()){
            ...
            showDialog(Language::get('feiwa_common_op_succ'),'','succ');
        }
...
public function uploadFeiwa() {
		if (!chksubmit()){
			redirect('index.php?app=member_information&feiwa=avatar');
		}
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'member':
                $menu_array = array(
                1=>array('menu_key'=>'member',  'menu_name'=>Language::get('home_member_base_infomation'),'menu_url'=>'index.php?app=member_information&feiwa=member'),
                2=>array('menu_key'=>'more',    'menu_name'=>Language::get('home_member_more'),'menu_url'=>'index.php?app=member_information&feiwa=more'),
                5=>array('menu_key'=>'avatar',  'menu_name'=>Language::get('home_member_modify_avatar'),'menu_url'=>'index.php?app=member_information&feiwa=avatar'));
                break;
        }
