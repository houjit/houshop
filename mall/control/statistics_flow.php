...
class statistics_flowControl extends BaseSellerControl{
     ...
     * 店铺流量统计
     */
    public function storeflowFeiwa() {
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'storeflow','menu_name'=>'店铺总流量','menu_url'=>'index.php?app=statistics_flow&feiwa=storeflow'),
            2=>array('menu_key'=>'goodsflow','menu_name'=>'商品流量排名','menu_url'=>'index.php?app=statistics_flow&feiwa=goodsflow')
        );
