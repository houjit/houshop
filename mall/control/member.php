...
class memberControl extends BaseMemberControl{
    ...
    public function ajax_load_member_infoFeiwa() {
    ...
    public function ajax_load_order_infoFeiwa() {
    ...
    public function ajax_load_goods_infoFeiwa() {
        //商品收藏
    ...
    public function ajax_load_sns_infoFeiwa() {
        //我的足迹
