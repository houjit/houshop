...
class store_account_groupControl extends BaseSellerControl {
    ...
    public function group_listFeiwa() {
    ...
    public function group_addFeiwa() {
        // 店铺消息模板列表
    ...
    public function group_editFeiwa() {
    ...
    public function group_saveFeiwa() {
        $seller_info = array();
        ...
        if (empty($_POST['group_id'])) {
            ...
            showDialog('添加成功', urlMall('store_account_group', 'group_list'),'succ');
        } else {
            $condition = array();
            ...
            showDialog('编辑成功', urlMall('store_account_group', 'group_list'),'succ');
        }
    }

    public function group_delFeiwa() {
    ...
    private function profile_menu($menu_key='') {
        ...
        $menu_array[] = array(
            'menu_key'=>'group_list',
            'menu_name' => '组列表',
            'menu_url' => urlMall('store_account_group', 'group_list')
        );
        if($menu_key === 'group_add') {
            $menu_array[] = array(
                'menu_key'=>'group_add',
                'menu_name' => '添加组',
                'menu_url' => urlMall('store_account_group', 'group_add')
            );
        }
        if($menu_key === 'group_edit') {
            $menu_array[] = array(
                'menu_key'=>'group_edit',
                'menu_name' => '编辑组',
                'menu_url' => urlMall('store_account_group', 'group_edit')
            );
        }
