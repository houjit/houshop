    ...
    <div class="feiwa-item-mn">
      <div class="name">
        ...
        <style>
            ...
            .pf .p0 {
                background: #ffa155 none repeat scroll 0 0;
                float: left;
                font-size: 16px;
                height: 90px;
                padding: 10px 0;
            ...
            .pf .p2 {
                background: #ff9742 none repeat scroll 0 0;
                float: left;
                font-size: 16px;
                height: 90px;
                padding: 10px 0;
            ...
            .pf .p3 {
                background: #fe9039 none repeat scroll 0 0;
                float: left;
                font-size: 16px;
                height: 90px;
                padding: 10px 0;
		...
		<?php $vv=unserialize($output['goods']['pf']);if($output['goods']['pf']&& $vv['q1']>0 && $vv['f1']>0){?>
	  <div class ="pf">	     
          <div class="p0"><p>　起批数量</p><br><p>　价格</p></div>  
          <div class="p1"><p>　<?php if ($vv['q2']==0 || $vv['f2']==0){?>≥<?php }?><?php echo $vv['q1'];?><?php if($vv['q2']>0&& $vv['f2']>0){?>－<?php echo intval($vv['q2']-1);?><?php }?> <?php echo $output['goods']['dw']; ?></p><br><p>　¥ <span><?php echo ncPriceFormat($vv['f1']); ?></span></p></div>
		  <div class="p2"><?php if($vv['q2']>0 && $vv['f2']>0){?><p>　<?php if ($vv['q3']==0 || $vv['f3']==0){?>≥<?php }?><?php echo $vv['q2'];?><?php if($vv['q3']>0&& $vv['f3']>0){?>－<?php echo intval($vv['q3']-1);?><?php }?> <?php echo $output['goods']['dw']; ?></p><br><p>　¥ <span><?php echo ncPriceFormat($vv['f2']); ?></span></p><?php }?></div>
		  <div class="p3"><?php if($vv['q3']>0 && $vv['f3']>0){?><p>　≥<?php echo $vv['q3'];?> <?php echo $output['goods']['dw']; ?></p><br><p>　¥ <span><?php echo ncPriceFormat($vv['f3']); ?></span></p><?php }?></div>
	  </div>
	  <?php }?>
...
$shownLevelSkus[$sku] = true; ?>
      ...
      <div class="feiwa-ss-logistics"><!-- S 物流与运费新布局展示 -->
