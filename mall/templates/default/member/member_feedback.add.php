...
<div class="ncm-flow-layout">
  <div id="ncmInformFlow" class="ncm-flow-container">
    ...
    <form id="mallconsult_form" method="post" action="<?php echo urlMall('member_feedback', 'save_fb');?>">
    ...
    <dl>
        <dt>标题<?php echo $lang['feiwa_colon'];?></dt>
        <dd>
          <div>
      ...
      <dl>
        <dt>内容<?php echo $lang['feiwa_colon'];?></dt>
        <dd>
...
//            },
            title : {
                required : '<i class="icon-exclamation-sign"></i>请填写标题'
            },
            consult_content : {
                required : '<i class="icon-exclamation-sign"></i>请填写内容'
            }
        }
    });
});
