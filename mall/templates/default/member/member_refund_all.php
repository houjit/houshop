  ...
  <div class="ncm-flow-container">
    ...
    <div id="saleRefund" show_id="1">
      ...
      <div class=" ncm-default-form">
        <div id="warning"></div>
        <form id="post_form1" enctype="multipart/form-data" method="post" action="index.php?app=member_refund&feiwa=add_refund_all&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">
