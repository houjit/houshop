  ...
  <div class="ncm-flow-container">
    ...
    <div id="saleRefund" show_id="1">
      ...
      <div class="ncm-default-form">
        <form id="post_form1" enctype="multipart/form-data" method="post" action="index.php?app=member_refund&feiwa=add_refund&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">
    ...
    <div id="saleRefundReturn" show_id="2" style="display: none;">
      ...
      <div class=" ncm-default-form">
        <div id="warning"></div>
        <form id="post_form2" method="post" enctype="multipart/form-data" action="index.php?app=member_refund&feiwa=add_refund&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">
          <input type="hidden" name="form_submit" value="ok" />
          ...
          <dl>
            <dt><i class="required">*</i><?php echo $lang['refund_order_refund'].$lang['feiwa_colon'];?></dt>
            <dd>
          ...
          <dl>
            <dt><i class="required">*</i><?php echo $lang['return_order_return'].$lang['feiwa_colon'];?></dt>
            <dd>
