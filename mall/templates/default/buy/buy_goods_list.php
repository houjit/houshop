...
>
        ...
        <td><!-- S 商品单价 -->
          ...
          <?php
				$ifpf=Model('goods')->getifpf($cart_info['goods_id'],$cart_info['goods_price']);
				$goods_info = Model()->table('goods')->where('goods_id='.$cart_info['goods_id'])->find();
           ...
           <?php if($ifpf==1){?>
            ...
            <dd>
              <p>享受批发模式价格</p>
              <p>数量:<?php echo $pf['q1']; ?>~<?php echo $pf['q2']-1; ?> 单价:<?php echo $pf['f1']; ?>元</p>
              <p>数量:<?php if($pf['q2']>0){?><?php echo $pf['q2']; ?>~<?php echo $pf['q3']-1; ?> <?php }else{?>≥<?php echo $pf['q2']; ?><?php }?>单价:<?php echo $pf['f2']; ?>元</p>
				 <?php if($pf['q3']>0){?><p>数量:≥<?php echo $pf['q3']; ?> 单价:<?php echo $pf['f3']; ?>元</p><?php }?>
            </dd>
          </dl>
          <?php } ?>
