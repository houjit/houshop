...
<div class="ncc-form-default">
  <form method="POST" id="addr_form" action="index.php">
    ...
    <dl>
      <dt><i class="required">*</i>门店<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>收货人<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
...
$(document).ready(function(){
	var chain = function(area_id){
	    $.getJSON(SITEURL + '/index.php?app=buy&feiwa=load_chain&area_id=' + area_id + '&store_id=' + chain_store_id + '&callback=?',function(data){
	...
	$("#region").feiwa_region({last_click:chain});
