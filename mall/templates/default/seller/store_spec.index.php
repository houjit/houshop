...
<div nctype="class_spec" class="feiwast-goods-spec">
...
function editSpecValue(o) {
    ...
    $_iframe = $('<iframe id="iframepage" name="iframepage" frameBorder=0 scrolling=no width="100%" height="630px" src="<?php echo MALL_SITE_URL;?>/index.php?app=store_spec&feiwa=add_spec&spid=' + data_str.spid + '&gcid=' + data_str.gcid + '" ></iframe>');
