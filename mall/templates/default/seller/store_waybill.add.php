...
<div class="feiwast-form-default">
  <form id="add_form" action="<?php echo urlMall('store_waybill', 'waybill_save');?>" method="post" enctype="multipart/form-data">
    ...
    <?php } ?>
    <dl>
      <dt><i class="required">*</i>模板名称<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>物流公司<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>宽度<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>高度<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>上偏移量<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>左偏移量<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>模板图片<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
        <?php if($output['waybill_info']) { ?>
    ...
    <dl>
      <dt><i class="required">*</i>启用<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
        <?php
        ...
        ?>
        <ul class="feiwast-form-radio-list"><li><label for="waybill_usable_1"><input id="waybill_usable_1" type="radio" name="waybill_usable" value="1" <?php echo $usable ? 'checked' : '';?>>
        是</label></li>
