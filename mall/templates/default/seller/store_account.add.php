...
<div class="feiwast-form-default">
  <form id="add_form" action="<?php echo urlMall('store_account', 'account_save');?>" method="post">
    <dl>
      <dt><i class="required">*</i>前台用户名<?php echo $lang['feiwa_colon'];?></dt>
    ...
    <dl>
      <dt><i class="required">*</i>用户密码<?php echo $lang['feiwa_colon'];?></dt>
    ...
    <dl>
      <dt><i class="required">*</i>登录账号<?php echo $lang['feiwa_colon'];?></dt>
...
$(document).ready(function(){
    jQuery.validator.addMethod("seller_name_exist", function(value, element, params) { 
        ...
        $.ajax({  
            type:"GET",  
            url:'<?php echo urlMall('store_account', 'check_seller_name_exist');?>',  
            async:false,  
    ...
    jQuery.validator.addMethod("check_member_password", function(value, element, params) { 
        ...
        $.ajax({  
            type:"GET",  
            url:'<?php echo urlMall('store_account', 'check_seller_member');?>',  
            async:false,  
