  ...
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlMall('store_goods_online', 'edit_save_goods');} else { echo urlMall('store_goods_add', 'save_goods');}?>">
    ...
    <div class="feiwast-form-goods">
      ...
      <dl>
        ...
        <dl>
            <dt><?php echo $lang['goods_class_index_goods_type'].$lang['feiwa_colon'];?></dt>
            <dd>
                <ul class="feiwast-form-radio-list">
                    <li>
                        <label><input name="goods_type" value="1" type="radio" checked="checked">全新</label>
                    </li>
                    <li>
                        <label><input name="goods_type" value="2" type="radio">二手</label>
                    </li>
                </ul>
            </dd>
        </dl>
      ...
      <!-- 批发 -->
      <dl>
        <dt feiwa_type="no_spec">批发设置:</dt>
        <dd feiwa_type="no_spec"><?php $pfs=unserialize($output['goods']['pfs'])?>
          第一阶：<input name="pfs[q1]" onblur="check_p()" data_type="q1" value="<?php echo $pfs['q1']; ?>" type="text"  class="text w50" />　起　<input name="pfs[f1]" data_type="f1_price" value="<?php echo $pfs['f1']; ?>" type="text"  class="text w30" /><em class="add-on"><i class="icon-renminbi"></i></em>　第二阶：<input name="pfs[q2]" onblur="check_p()" data_type="q2" value="<?php echo $pfs['q2']; ?>" type="text"  class="text w50" />　起　<input name="pfs[f2]" data_type="f2_price" value="<?php echo $pfs['f2']; ?>" type="text"  class="text w30" /><em class="add-on"><i class="icon-renminbi"></i></em> 　第三阶：<input data_type="q3" onblur="check_p()" name="pfs[q3]" value="<?php echo $pfs['q3']; ?>" type="text"  class="text w50" />　起　<input name="pfs[f3]" data_type="f3_price" value="<?php echo $pfs['f3']; ?>" type="text"  class="text w30" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
          <p class="hint">如设置了规格当前不可用<br>
            此价格为商品实际批发价格，共三个阶段，每个阶段只需要设置数量、数量价格。</p>
        </dd>
      </dl>
      <dl>
...
function check_p(){
	$('input[data_type="q1"]').each(function(){
...
function goods_stock_set(){
    ...
    //批发
    $('input[name="pfs[q1]"]').attr('readonly','readonly').css('background','#E7E7E7 none');
		$('input[name="pfs[f1]"]').attr('readonly','readonly').css('background','#E7E7E7 none');
		$('input[name="pfs[q2]"]').attr('readonly','readonly').css('background','#E7E7E7 none');
		$('input[name="pfs[f2]"]').attr('readonly','readonly').css('background','#E7E7E7 none');
		$('input[name="pfs[q3]"]').attr('readonly','readonly').css('background','#E7E7E7 none');
		$('input[name="pfs[f3]"]').attr('readonly','readonly').css('background','#E7E7E7 none');
    ...
    if(str == '<tr>'){
        ...
        // 批发
        $('input[name="pfs[q1]"]').removeAttr('readonly').css('background','');
		$('input[name="pfs[f1]"]').removeAttr('readonly').css('background','');
		$('input[name="pfs[q2]"]').removeAttr('readonly').css('background','');
		$('input[name="pfs[f2]"]').removeAttr('readonly').css('background','');
		$('input[name="pfs[q3]"]').removeAttr('readonly').css('background','');
		$('input[name="pfs[f3]"]').removeAttr('readonly').css('background','');
...
function recursionSpec($len,$sign) {
    if($len < $sign){
        ...
        echo "str +='<td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][marketprice]\" data_type=\"marketprice\" feiwa_type=\"'+spec_bunch+'|marketprice\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td>' +
                    ...
                    '</tr><tr id=\"'+spec_bunch+'\" ><td colspan=\"8\" style=\"border-top:solid 0px #BCE8F1\">批发设置：第一阶：<input data_type=\"q1\" class=\"text stock\" type=\"text\" onblur=\"check_p()\" name=\"spec['+spec_bunch+'][pf][q1]\"  feiwa_type=\"'+spec_bunch+'|q1\" value=\"\" />　起　<input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][pf][f1]\" data_type=\"f1_price\" feiwa_type=\"'+spec_bunch+'|f1\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em>　第二阶：<input onblur=\"check_p()\" class=\"text stock\" data_type=\"q2\" type=\"text\" name=\"spec['+spec_bunch+'][pf][q2]\" feiwa_type=\"'+spec_bunch+'|q2\" value=\"\" />　起　<input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][pf][f2]\" data_type=\"f2_price\" feiwa_type=\"'+spec_bunch+'|f2\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em>　第三阶：<input onblur=\"check_p()\" data_type=\"q3\"class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][pf][q3]\"  feiwa_type=\"'+spec_bunch+'|q3\" value=\"\" />　起　<input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][pf][f3]\" data_type=\"f3_price\" feiwa_type=\"'+spec_bunch+'|f3\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td></tr>';\n";
