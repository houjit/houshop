...
<table class="feiwast-default-table order">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
		<p>
			<?php echo ncPriceFormat($goods['goods_price']); ?>
			<?php
				$ifpf=Model('goods')->getifpf($goods['goods_id'],$goods['goods_price']);
				if($ifpf==1){
			?>
			<img title="批发产品" src="<?php echo MALL_TEMPLATES_URL;?>/images/p.png" />
			<?php
				}
			?>
		</p>
